...
ALLOWLIST: dict[tuple[str, str], str] = {
    ...
    ("autobot-backend/mcp_server/autobot_server.py", "AutoBotMCPServer._kb_get_document"): _T4,
    ("autobot-backend/mcp_server/autobot_server.py", "AutoBotMCPServer._kb_search"): _T4,
