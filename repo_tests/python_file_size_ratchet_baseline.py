...
RATCHET_BASELINE: dict[str, int] = {
    ...
    "autobot-backend/api/monitoring.py": 1319,
    "autobot-backend/api/multimodal.py": 833,
    ...
    "autobot-backend/code_intelligence/code_review_engine.py": 1219,
    ...
    "autobot-backend/code_intelligence/llm_pattern_analyzer_test.py": 1105,
    ...
    "autobot-backend/code_intelligence/precommit_analyzer.py": 720,
    ...
    "autobot-slm-backend/services/playbook_executor.py": 1402,  # #17150: ansible_dir self-heal, re-detect before sync
