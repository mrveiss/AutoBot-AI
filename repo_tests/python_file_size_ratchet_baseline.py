...
RATCHET_BASELINE: dict[str, int] = {
    ...
    "autobot-backend/security/enterprise/compliance_manager.py": 911,
    "autobot-backend/security/enterprise/security_policy_manager.py": 957,
    "autobot-backend/security/enterprise/sso_integration.py": 917,
    "autobot-backend/security/enterprise/threat_detection/engine.py": 720,
