...
RATCHET_BASELINE: dict[str, int] = {
    ...
    "autobot-backend/initialization/lifespan.py": 2770,
    ...
    "autobot-backend/security/threat_intelligence.py": 772,
    ...
    "autobot-backend/services/execution/claude_code_backend.py": 662,
    ...
    "autobot-backend/services/notification_service.py": 635,
