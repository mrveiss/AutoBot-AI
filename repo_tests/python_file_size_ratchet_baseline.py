...
RATCHET_BASELINE: dict[str, int] = {
    ...
    "autobot-backend/api/analytics.py": 1288,
    ...
    "autobot-backend/api/terminal_handlers.py": 1504,
    ...
    "autobot-backend/security/enterprise/compliance_manager.py": 922,
    "autobot-backend/security/enterprise/security_policy_manager.py": 968,
    "autobot-backend/security/enterprise/sso_integration.py": 928,
    "autobot-backend/security/enterprise/threat_detection/engine.py": 731,
    ...
    "autobot_shared/ssot_config.py": 3299,
