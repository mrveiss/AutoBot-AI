...
# Author: mrveiss
"""Data module for ``repo_tests/python_file_size_ratchet_test.py``'s ``RATCHET_BASELINE``.

Split out from the test itself (#14547) so the test file stays well under
MAX_LINES without needing a self-referential grandfather entry.
...
a list only ever compared against itself can drift anywhere — and neither
copy is derived from the other at runtime (both are checked in, independently,
by whoever lowers a ceiling). The hook's ceilings are anchored to the files by
``audit_ceilings``; this dict is anchored to them by
``test_the_baseline_is_relowered_by_every_shrink``. So no ceiling can be
raised by editing one file alone: a bump here alone exceeds the file it
names, a bump in ``scripts/python_file_size_known_large.py`` alone exceeds
this dict.

Sync this dict DOWN with every shrink; never up to make a test pass.
"""
...
RATCHET_BASELINE: dict[str, int] = {
    ...
    "autobot-backend/agents/security_scanner_agent.py": 662,
    ...
    "autobot-backend/api/agent_terminal.py": 1112,
    ...
    "autobot-backend/api/analytics_llm_patterns.py": 1014,
    ...
    "autobot-backend/api/api_endpoint_migrations_test.py": 31019,
    "autobot-backend/api/auth.py": 777,
    "autobot-backend/api/batch_jobs.py": 964,
    "autobot-backend/api/browser_mcp.py": 1415,
    ...
    "autobot-backend/api/chat_sessions.py": 2040,
    "autobot-backend/api/code_intelligence.py": 2155,
    "autobot-backend/api/code_search.py": 924,
    "autobot-backend/api/codebase_analytics/analyzers.py": 1683,
    ...
    "autobot-backend/api/knowledge.py": 3445,
    ...
    "autobot-backend/api/mcp_registry.py": 1168,
    ...
    "autobot-backend/api/schemas_analytics.py": 3599,
    ...
    "autobot-backend/api/websockets.py": 1032,
    "autobot-backend/api/workflow.py": 1027,
    "autobot-backend/async_baseline_performance_test.py": 623,
    ...
    "autobot-backend/comprehensive_system_validation_test.py": 777,
    "autobot-backend/computer_vision/screen_analyzer.py": 662,
    "autobot-backend/conftest.py": 1639,
    "autobot-backend/context_aware_decision/decision_engine.py": 815,
    "autobot-backend/context_aware_decision/tests/test_counterfactual_reasoner.py": 662,
    ...
    "autobot-backend/initialization/lifespan.py": 2611,
    ...
    "autobot-backend/knowledge/connectors/credential_store.py": 738,
    ...
    "autobot-backend/knowledge/facts.py": 1778,
    "autobot-backend/knowledge/knowledge_performance_test.py": 852,
    ...
    "autobot-backend/knowledge/stats.py": 986,
    ...
    "autobot-backend/llc/api/companies.py": 1794,
    "autobot-backend/llc/api/roles.py": 741,
    "autobot-backend/llc/api/sprints.py": 1223,
    "autobot-backend/llc/api/work_items.py": 1415,
    "autobot-backend/llc/scheduler/heartbeat_scheduler.py": 1055,
    "autobot-backend/llc/services/portability.py": 829,
    ...
    "autobot-backend/llc/tests/test_heartbeat_scheduler.py": 950,
    ...
    "autobot-backend/monitoring/monitoring_and_alerts_test.py": 1191,
    ...
    "autobot-backend/performance_benchmarks_test.py": 633,
    ...
    "autobot-backend/project_state_manager.py": 996,
    ...
    "autobot-backend/secure_command_executor.py": 1232,
    ...
    "autobot-backend/security/enterprise/compliance_manager.py": 921,
    "autobot-backend/security/enterprise/security_policy_manager.py": 967,
    "autobot-backend/security/enterprise/sso_integration.py": 928,
    "autobot-backend/security/enterprise/threat_detection/engine.py": 730,
    "autobot-backend/security/input_validator.py": 607,
    "autobot-backend/security/prompt_injection_detector.py": 736,
    "autobot-backend/security/security_edge_cases_test.py": 638,
    "autobot-backend/security/session_ownership.py": 825,
    "autobot-backend/security/threat_detection_refactor_test.py": 880,
    "autobot-backend/security/threat_intelligence.py": 771,
    "autobot-backend/security_layer.py": 744,
    ...
    "autobot-backend/services/command_approval_manager.py": 654,
    ...
    "autobot-backend/services/notification_service.py": 604,
    "autobot-backend/services/npu_worker_manager.py": 1419,
    "autobot-backend/services/rag_service.py": 1312,
    "autobot-backend/services/redis_service_api_integration_test.py": 832,
    ...
    "autobot-backend/slash_command_handler.py": 1632,
    ...
    "autobot-backend/tests/integration/test_causal_framework_integration.py": 1144,
    ...
    "autobot-backend/tests/memory_graph/test_property_graph.py": 677,
    ...
    "autobot-backend/utils/error_catalog.py": 706,
    ...
    "autobot-backend/utils/hardware_metrics.py": 1553,
    "autobot-backend/utils/hardware_metrics_test.py": 714,
    ...
    "autobot-backend/utils/timeout_migration_examples.py": 1023,
    ...
    "autobot-backend/workers/audit_tasks.py": 901,
    "autobot-backend/workers/audit_tasks_test.py": 804,
    ...
    "autobot-slm-backend/api/code_sync.py": 5765,
    ...
    "autobot-slm-backend/api/nodes.py": 2980,
    ...
    "autobot-slm-backend/api/setup_wizard.py": 1262,
    "autobot-slm-backend/api/stateful.py": 688,
    "autobot-slm-backend/api/tls.py": 994,
    "autobot-slm-backend/api/updates.py": 1129,
    "autobot-slm-backend/main.py": 791,
    "autobot-slm-backend/models/database.py": 1184,
    "autobot-slm-backend/models/schemas.py": 2329,
    ...
    "autobot_shared/env_registry.py": 1839,
    "autobot_shared/http_client.py": 685,
    "autobot_shared/monitoring/prometheus_metrics.py": 942,
    ...
    "autobot_shared/ssot_config.py": 3279,
    "autobot_shared/ssot_config_test.py": 784,
    "autobot_shared/ssot_constants.py": 945,
    "autobot_shared/user_management/team_service.py": 725,
    "pipeline-scripts/check-pre-commit-hook-pr_test.py": 751,
