...
RATCHET_BASELINE: dict[str, int] = {
    ...
    "autobot-backend/modern_ai_integration.py": 1142,
    ...
    "autobot-slm-backend/api/code_sync.py": 6083,  # #15710: env-cast conversion dropped health-poll scaffolding
    ...
    "autobot-slm-backend/api/services.py": 1221,
