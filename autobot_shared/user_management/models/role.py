...
# Author: mrveiss
"""
Role and Permission Models (#12647)
...
the backend kept an unused ``typing.Optional`` import and spelled optional
relationships as ``Mapped[Optional["Organization"]]``; SLM already used the
``Mapped["Organization | None"]`` form this repo's canonical ``models/base.py``
(#12647) also uses. This file adopts SLM's form; no semantic content changed.
"""
