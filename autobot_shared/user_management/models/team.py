...
# Author: mrveiss
"""
Team and Team Membership Models (#12647)

Byte-identical between ``autobot-backend`` and ``autobot-slm-backend`` before
this move — no reconciliation was needed, only the relocation itself.
"""
...
from autobot_shared.user_management.models.base import Base, TenantMixin
