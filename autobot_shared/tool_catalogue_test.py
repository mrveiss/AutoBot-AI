...
_ORIG_INFRA_AND_SHELL = {
    "bash", "shell", "execute_command", "run_command", "system_exec",
    "deploy", "ansible", "docker", "kubectl", "helm", "terraform",
}

_ORIG_SENSITIVE = {
    "write_file", "edit_file", "delete_file", "move_file", "copy_file",
    "create_directory", "remove_directory", "bash", "shell", "execute_command",
    "run_command", "terminal", "system_exec", "deploy", "ansible", "docker",
    "kubectl", "helm", "terraform", "git_push", "git_commit", "git_merge",
    "git_rebase", "git_reset", "git_force_push", "http_post", "http_put",
    "http_patch", "http_delete", "send_request", "code_interpreter",
}
...
_ORIG_APPROVAL = {
    ...
    "destructive operations": {
        "delete_file", "remove_directory", "bash", "shell", "execute_command",
