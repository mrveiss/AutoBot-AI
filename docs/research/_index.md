...
| [[community-prompt-and-skill-registry]] | prompts.chat + `f/awesome-chatgpt-prompts` — source analysis and AutoBot comparison. Sources and the three mechanism-bearing skills are named at operator instruction. Corpus has **zero** self-correcting entries; our loop design is ahead on every axis. Four adoptions + three defects filed as umbrella #16108 (children #16110–#16116); #16105 filed by a peer |
