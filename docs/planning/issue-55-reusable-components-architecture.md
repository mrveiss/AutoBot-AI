...
### 3. Knowledge Extraction ✅ (autobot-backend/agents/knowledge_extraction_agent.py)
...
### 5. Redis Infrastructure ✅ (autobot-backend/utils/redis_client.py)
...
**Location:** `autobot-backend/agents/graph_entity_extractor.py`
...
**Location:** `autobot-frontend/src/components/graph/`

**Modular Design:**
```
autobot-frontend/src/components/graph/
...
**New Code (10%):**
- `autobot-backend/agents/graph_entity_extractor.py` - Mapping layer (200 lines)
...
- `autobot-frontend/src/components/graph/` - 6 components (~800 lines total)
...
autobot-backend/agents/graph_entity_extractor.py            # Reusable entity extractor
autobot-backend/api/graph_rag.py                        # Reusable API endpoints
