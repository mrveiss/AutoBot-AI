...
- **Agent:** `senior-backend-engineer`
- **Files:** `autobot-backend/api/chat_enhanced.py`
...
- **Agent:** `senior-backend-engineer`
- **Files:** `autobot-backend/api/websockets.py`
...
- **Agent:** `senior-backend-engineer`
- **Files:** `autobot-backend/api/file_upload.py`
...
./scripts/utilities/sync-to-vm.sh main autobot-backend/api/chat_enhanced.py /home/autobot/autobot-backend/api/
./scripts/utilities/sync-to-vm.sh main src/chat_workflow_manager.py /home/autobot/src/
...
- `autobot-backend/api/chat_enhanced.py` - Auth headers, context window
- `autobot-backend/api/websockets.py` - Auth headers
