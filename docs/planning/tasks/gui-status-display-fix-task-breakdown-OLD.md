...
grep -r "systemStatus\|systemServices\|refreshSystemStatus" autobot-frontend/src/components/

# Search for parent/root references
grep -r "\$parent\|\$root" autobot-frontend/src/components/ | grep -i status
```
...
**Action Items:**
- [ ] Create test file: `autobot-frontend/tests/unit/composables/useSystemStatus.spec.js`
...
**Action Items:**
- [ ] Create test file: `autobot-frontend/tests/integration/AppStatusIntegration.spec.js`
...
```bash
# Sync App.vue to VM1
./scripts/utilities/sync-to-vm.sh frontend autobot-frontend/src/App.vue /home/autobot/autobot-frontend/src/App.vue

# Sync composable (if modified)
./scripts/utilities/sync-to-vm.sh frontend autobot-frontend/src/composables/useSystemStatus.js /home/autobot/autobot-frontend/src/composables/useSystemStatus.js
...
git checkout <previous-commit-hash> autobot-frontend/src/App.vue
