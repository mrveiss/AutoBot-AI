...
**Affected Files:**
- **CREATE:** `autobot-backend/api/service_management.py`
...
**Affected Files:**
- **MODIFY:** `backend/services/redis_service_manager.py`
- **MODIFY:** `autobot-backend/api/websockets.py` (WebSocket notifications)
...
**Affected Files:**
- **CREATE:** `autobot-frontend/src/components/services/RedisServiceControl.vue`
...
**Affected Files:**
- **CREATE:** `autobot-frontend/src/components/services/ServiceStatusBadge.vue`
...
**Affected Files:**
- **CREATE:** `autobot-frontend/src/components/services/ServiceLogsViewer.vue`
...
**Affected Files:**
- **CREATE:** `autobot-frontend/src/components/common/ConfirmDialog.vue` (or use existing)
...
**Affected Files:**
- **CREATE:** `autobot-frontend/src/composables/useServiceManagement.js`
...
**Affected Files:**
- **CREATE:** `autobot-frontend/src/services/RedisServiceAPI.js`
...
**Affected Files:**
- **MODIFY:** `autobot-frontend/src/composables/useServiceManagement.js`
- **MODIFY:** `autobot-frontend/src/composables/useWebSocket.js` (or use existing)
...
**Affected Files:**
- **MODIFY:** `autobot-frontend/src/components/NavigationMenu.vue` (or similar)
- **MODIFY:** `autobot-frontend/src/router/index.js`
...
**Affected Files:**
- **MODIFY:** `autobot-frontend/src/views/Dashboard.vue` (or similar)
...
**Affected Files:**
- **CREATE:** `autobot-frontend/tests/components/RedisServiceControl.spec.js`
...
**Affected Files:**
- **CREATE:** `autobot-frontend/tests/e2e/service-management.spec.js`
...
**Affected Files:**
- **MODIFY:** `autobot-backend/api/service_management.py`
...
- `autobot-backend/api/service_management.py` - API router
- `backend/models/service_management.py` - Response models
- `config/services/redis_service_management.yaml` - Configuration

**Frontend Files:**
- `autobot-frontend/src/components/services/RedisServiceControl.vue` - Main UI
- `autobot-frontend/src/composables/useServiceManagement.js` - Logic composable
- `autobot-frontend/src/services/RedisServiceAPI.js` - API client
