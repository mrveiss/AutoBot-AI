...
3. **autobot-backend/api/workflow_automation.py** expects:
...
2. `autobot-backend/api/workflow_automation.py` (line 23, 133)
3. `autobot-backend/api/advanced_workflow_orchestrator.py` (line 25)
4. `autobot-backend/utils/resource_factory.py` (line 90)
