...
**New File:** `autobot-backend/api/config_validation.py`
...
1. Create `autobot-backend/api/config_validation.py`
...
**File:** `autobot-backend/api/settings_sync.py`
...
1. Create `autobot-backend/api/settings_sync.py`
