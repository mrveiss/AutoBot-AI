...
**API Endpoint**: `autobot-backend/api/graph_rag.py`
...
**File**: `autobot-backend/agents/graph_entity_extractor.py` (600+ lines)
...
**File**: `autobot-backend/api/entity_extraction.py` (350+ lines)
...
1. **Main Canvas**: `autobot-frontend/src/components/graph/GraphCanvas.vue`
...
3. **State Management**: `autobot-frontend/src/composables/useGraphState.ts`
   - Graph data fetching
   - Node/edge selection
   - Filter state
   - Layout algorithms
