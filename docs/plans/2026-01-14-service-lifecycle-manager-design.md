...
- [x] REST API for nodes and heartbeats (`autobot-backend/api/slm/`)
...
- [x] Heartbeat collection API (`autobot-backend/api/slm/heartbeats.py`)
...
- [x] WebSocket real-time updates (`autobot-backend/api/slm/websockets.py`)
...
- [x] Deployment REST API (`autobot-backend/api/slm/deployments.py`)
...
- [x] Stateful services REST API (`autobot-backend/api/slm/stateful.py`)
