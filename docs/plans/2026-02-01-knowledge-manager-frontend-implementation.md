...
**Architecture:** Extend the existing modular architecture in `autobot-frontend/src/components/knowledge/`. Add new Vue 3 Composition API components with TypeScript. Use the existing `useKnowledgeStore` for state management. Backend APIs are stable and ready.
...
**Files:**
- Modify: `autobot-frontend/src/stores/useKnowledgeStore.ts`
- Reference: `autobot-backend/api/knowledge_categories.py`, `autobot-backend/api/prompts.py`
...
```bash
git add autobot-frontend/src/stores/useKnowledgeStore.ts
...
**Files:**
- Create: `autobot-frontend/src/components/knowledge/modals/CategoryEditModal.vue`
- Reference: `autobot-frontend/src/components/ui/BaseModal.vue`

**Step 1: Create modals directory**

```bash
mkdir -p autobot-frontend/src/components/knowledge/modals
```
...
```bash
git add autobot-frontend/src/components/knowledge/modals/CategoryEditModal.vue
...
**Files:**
- Modify: `autobot-frontend/src/components/knowledge/KnowledgeCategories.vue`
...
```bash
git add autobot-frontend/src/components/knowledge/KnowledgeCategories.vue
...
**Files:**
- Create: `autobot-frontend/src/components/knowledge/KnowledgeSystemDocs.vue`
...
```bash
git add autobot-frontend/src/components/knowledge/KnowledgeSystemDocs.vue
...
**Files:**
- Create: `autobot-frontend/src/components/knowledge/modals/DocumentExportModal.vue`
...
```bash
git add autobot-frontend/src/components/knowledge/modals/DocumentExportModal.vue
...
**Files:**
- Create: `autobot-frontend/src/components/knowledge/KnowledgePromptEditor.vue`
...
```bash
git add autobot-frontend/src/components/knowledge/KnowledgePromptEditor.vue
...
**Files:**
- Create: `autobot-frontend/src/components/knowledge/modals/PromptHistoryModal.vue`
...
```bash
git add autobot-frontend/src/components/knowledge/modals/PromptHistoryModal.vue
...
**Files:**
- Create: `autobot-frontend/src/components/knowledge/panels/SourcePreviewPanel.vue`

**Step 1: Create panels directory and component**

```bash
mkdir -p autobot-frontend/src/components/knowledge/panels
```
...
```bash
git add autobot-frontend/src/components/knowledge/panels/SourcePreviewPanel.vue
...
**Files:**
- Modify: `autobot-frontend/src/components/knowledge/KnowledgeManager.vue`
...
```bash
git add autobot-frontend/src/components/knowledge/KnowledgeManager.vue
...
**Files:**
- Modify: `autobot-frontend/src/components/ChatInterface.vue` or relevant chat message component
...
```bash
git add autobot-frontend/src/components/ChatInterface.vue
...
**Files:**
- Modify: `autobot-frontend/src/components/knowledge/KnowledgeUpload.vue`
...
```bash
git add autobot-frontend/src/components/knowledge/KnowledgeUpload.vue
...
**Files:**
- Modify: `autobot-frontend/src/components/knowledge/KnowledgeEntries.vue`
...
```bash
git add autobot-frontend/src/components/knowledge/KnowledgeEntries.vue
...
Create `autobot-frontend/src/composables/useToast.ts` if it doesn't exist.
