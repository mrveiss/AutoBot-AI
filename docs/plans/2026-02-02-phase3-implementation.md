...
## Task 4: Update autobot-backend/api/agent_config.py to Use SLM Client

**Files:**
- Modify: `autobot-backend/api/agent_config.py`

**Step 1: Add SLM client import and helper function**

Add to imports at top of `autobot-backend/api/agent_config.py`:
...
```bash
git add autobot-backend/api/agent_config.py
...
**Files:**
- Modify: `autobot-frontend/src/config/ssot-config.ts`
...
```bash
git add autobot-frontend/src/config/ssot-config.ts
...
**Files:**
- Create: `autobot-frontend/src/composables/useServiceDiscovery.ts`
...
```bash
git add autobot-frontend/src/composables/useServiceDiscovery.ts
...
- [x] Updated autobot-backend/api/agent_config.py to use SLM client with local fallback
