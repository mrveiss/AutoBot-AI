...
├── # ═══════════════════════════════════════════════════════════
│
├── autobot-user-backend/           # → 172.16.168.20 (Main)
...
│
├── autobot-user-frontend/          # → 172.16.168.20 (Main)
│   ├── src/                        # Vue source
│   ├── public/                     # Static assets
│   ├── package.json                # Node dependencies
│   └── README.md
│
├── autobot-slm-backend/            # → 172.16.168.19 (SLM)
│   ├── api/                        # FastAPI endpoints
...
│   └── README.md
│
├── autobot-slm-frontend/           # → 172.16.168.21 (Frontend VM)
│   ├── src/                        # Vue source
│   ├── public/
│   ├── package.json
│   └── README.md
│
├── autobot-npu-worker/             # → 172.16.168.22 (NPU)
...
│   └── README.md
│
├── autobot-browser-worker/         # → 172.16.168.25 (Browser)
...
| Current | New |
|---------|-----|
| `docker/`, `Dockerfile`, `docker-compose.yml` | `infrastructure/docker/` |
| `scripts/` | `infrastructure/scripts/` |
| `config/` | `infrastructure/config/` |
| `certs/` | `infrastructure/certs/` |
| `tests/` | `infrastructure/tests/` |
| `mcp-servers/`, `mcp-tools/` | `infrastructure/mcp/` |
| `novnc/` | `infrastructure/novnc/` |
| `analysis/`, `code-analysis-suite/`, `reports/` | `infrastructure/analysis/` |
