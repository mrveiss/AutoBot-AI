...
**Files:**
- Modify: `autobot-frontend/src/composables/useCodeIntelligence.ts`
...
```bash
git add autobot-frontend/src/composables/useCodeIntelligence.ts
...
**Files:**
- Modify: `autobot-frontend/src/types/codeIntelligence.ts`
- Modify: `autobot-frontend/src/composables/useCodeIntelligence.ts`
...
```bash
git add autobot-frontend/src/types/codeIntelligence.ts autobot-frontend/src/composables/useCodeIntelligence.ts
...
```bash
mkdir -p autobot-frontend/src/components/analytics/code-intelligence
```
...
```bash
git add autobot-frontend/src/components/analytics/code-intelligence/FindingsTable.vue
...
**Files:**
- Create: `autobot-frontend/src/components/analytics/code-intelligence/SecurityFindingsPanel.vue`
- Create: `autobot-frontend/src/components/analytics/code-intelligence/PerformanceFindingsPanel.vue`
- Create: `autobot-frontend/src/components/analytics/code-intelligence/RedisFindingsPanel.vue`
...
```bash
git add autobot-frontend/src/components/analytics/code-intelligence/
...
**Files:**
- Create: `autobot-frontend/src/components/analytics/code-intelligence/FileScanModal.vue`
...
```bash
git add autobot-frontend/src/components/analytics/code-intelligence/FileScanModal.vue
...
**Files:**
- Modify: `autobot-frontend/src/components/analytics/CodeIntelligenceDashboard.vue`
...
```bash
git add autobot-frontend/src/components/analytics/CodeIntelligenceDashboard.vue
