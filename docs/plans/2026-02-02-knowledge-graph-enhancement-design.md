...
```
autobot-backend/knowledge/pipeline/
├── __init__.py
...
```python
# autobot-backend/knowledge/pipeline/registry.py
...
```python
# autobot-backend/knowledge/pipeline/base.py
...
```python
# autobot-backend/knowledge/pipeline/runner.py
import asyncio
...
```python
# autobot-backend/knowledge/pipeline/models/entity.py
...
```python
# autobot-backend/knowledge/pipeline/models/relationship.py
from pydantic import BaseModel, Field
...
```python
# autobot-backend/knowledge/pipeline/cognifiers/entity_extractor.py
...
```python
# autobot-backend/knowledge/pipeline/cognifiers/relationship_extractor.py
...
```python
# autobot-backend/knowledge/pipeline/loaders/redis_graph_loader.py
...
```python
# autobot-backend/knowledge/pipeline/models/event.py
from pydantic import BaseModel, Field
...
```python
# autobot-backend/knowledge/pipeline/cognifiers/event_extractor.py
...
```python
# autobot-backend/knowledge/pipeline/models/summary.py
from pydantic import BaseModel, Field
from typing import Literal
from uuid import UUID, uuid4
from datetime import datetime
...
```python
# autobot-backend/knowledge/pipeline/cognifiers/summarizer.py
...
```python
# autobot-backend/knowledge/summary_search.py
