...
- [ ] `autobot-backend/api/slm/deployments.py` - See `slm-server/api/deployments.py`
- [ ] `autobot-backend/api/slm/heartbeats.py` - See `slm-server/api/nodes.py` (heartbeat endpoints)
- [ ] `autobot-backend/api/slm/websockets.py` - See `slm-server/api/websocket.py`
- [ ] `autobot-backend/api/slm/__init__.py` - Package file (delete with directory)
...
|-----------|---------------|-------------------|---------|
| Node Management | Disabled | ✅ Active | Delete autobot-backend/api/slm/nodes.py |
| Deployments | Disabled | ✅ Active | Delete autobot-backend/api/slm/deployments.py |
| Heartbeats | Disabled | ✅ Active | Delete autobot-backend/api/slm/heartbeats.py |
| Stateful Services | Disabled | ✅ Active | Delete autobot-backend/api/slm/stateful.py |
| WebSockets | Disabled | ✅ Active | Delete autobot-backend/api/slm/websockets.py |
...
2. Commenting out imports in `autobot-backend/api/slm/` files
3. Commenting out router registrations in `core_routers.py`
4. Disabling reconciler initialization in `lifespan.py`

Next step: Delete `autobot-backend/api/slm/` directory entirely and clean up supporting files.
