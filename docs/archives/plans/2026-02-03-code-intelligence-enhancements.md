...
**Files:**
- Create: `autobot-frontend/src/types/codeIntelligence.ts`
...
Run: `ls -la autobot-frontend/src/types/codeIntelligence.ts`
Expected: File exists with correct permissions

**Step 3: Commit**

```bash
git add autobot-frontend/src/types/codeIntelligence.ts
...
**Files:**
- Create: `autobot-frontend/src/composables/useCodeIntelligence.ts`
...
Run: `ls -la autobot-frontend/src/composables/useCodeIntelligence.ts`
...
**Files:**
- Create: `autobot-frontend/src/components/analytics/HealthScoreGauge.vue`
...
Run: `ls -la autobot-frontend/src/components/analytics/HealthScoreGauge.vue`
Expected: File exists

**Step 3: Commit**

```bash
git add autobot-frontend/src/components/analytics/HealthScoreGauge.vue
...
**Files:**
- Create: `autobot-frontend/src/components/analytics/CodeIntelligenceDashboard.vue`
...
Run: `ls -la autobot-frontend/src/components/analytics/CodeIntelligenceDashboard.vue`
Expected: File exists
...
- Modify: `autobot-frontend/src/views/AnalyticsView.vue`
...
```bash
git add autobot-frontend/src/router/index.ts autobot-frontend/src/views/AnalyticsView.vue
...
Run: `./scripts/utilities/sync-to-vm.sh frontend autobot-frontend/src/ /home/autobot/autobot-frontend/src/`
