...
**Files:**
- Create: `autobot-frontend/src/types/workflowTemplates.ts`
...
Run: `ls -la autobot-frontend/src/types/workflowTemplates.ts`

**Step 3: Commit**

```bash
git add autobot-frontend/src/types/workflowTemplates.ts
...
**Files:**
- Create: `autobot-frontend/src/composables/useWorkflowTemplates.ts`
...
Run: `ls -la autobot-frontend/src/composables/useWorkflowTemplates.ts`

**Step 3: Commit**

```bash
git add autobot-frontend/src/composables/useWorkflowTemplates.ts
...
**Files:**
- Modify: `autobot-frontend/src/components/workflow/WorkflowTemplateGallery.vue`
...
```bash
git add autobot-frontend/src/components/workflow/WorkflowTemplateGallery.vue
...
**Files:**
- Modify: `autobot-frontend/src/composables/useWorkflowBuilder.ts`
