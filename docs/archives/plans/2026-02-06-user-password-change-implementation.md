...
**Files:**
- Modify: `autobot-backend/api/user_management/users.py:360-394`
...
```python
# Modify autobot-backend/api/user_management/users.py
from src.user_management.middleware.rate_limit import (
    PasswordChangeRateLimiter,
    RateLimitExceeded,
)
...
```bash
git add autobot-backend/api/user_management/users.py tests/api/user_management/test_users_password_change.py
...
**Files:**
- Create: `autobot-frontend/src/components/profile/ProfileModal.vue`
