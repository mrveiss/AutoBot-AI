...
### 2. **Research Agent API** (`autobot-backend/agents/research_agent.py`)
...
### 3. **Workflow API Backend** (`autobot-backend/api/workflow.py`)
...
### 4. **Frontend UI Components** (`autobot-frontend/src/components/WorkflowApproval.vue`)
...
### 5. **Service Layer** (`autobot-frontend/src/services/api.js`)
