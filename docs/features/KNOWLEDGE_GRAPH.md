...
### 3. Entity Extraction (`autobot-backend/agents/graph_entity_extractor.py`)
...
### 4. REST API (`autobot-backend/api/memory.py`)
...
### 5. Visualization (`autobot-frontend/src/components/knowledge/KnowledgeGraph.vue`)
