...
**Location**: `autobot-frontend/src/components/visualizations/ResourceHeatmap.vue`
...
**Location**: `autobot-frontend/src/components/visualizations/WorkflowVisualization.vue`
...
**Location**: `autobot-frontend/src/components/visualizations/AgentActivityVisualization.vue`
...
**Location**: `autobot-frontend/src/components/visualizations/SystemArchitectureDiagram.vue`
...
**Location**: `autobot-frontend/src/components/knowledge/KnowledgeGraph.vue`
...
**Location**: `autobot-frontend/src/views/CustomDashboard.vue`
