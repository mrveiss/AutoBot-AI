...
**File Changes:**
- **`autobot-backend/api/chat.py`**: Add RAG pipeline before LLM call
- **`autobot-backend/agents/chat_agent.py`**: Integrate knowledge retrieval
...
1. **Create Knowledge-Aware Agent**
   ```python
   # autobot-backend/agents/knowledge_chat_agent.py
...
**File Changes:**
- **`autobot-backend/agents/knowledge_chat_agent.py`**: New agent
- **`autobot-backend/agents/agent_orchestrator.py`**: Route to knowledge agent
...
```python
# autobot-backend/api/chat.py - Enhanced chat endpoint
...
- **Chat API**: [`autobot-backend/api/chat.py`](../../autobot-backend/api/chat.py)
- **Knowledge Base V2**: [`src/knowledge_base_v2.py`](../../src/knowledge_base_v2.py)
- **RAG Agent**: [`autobot-backend/agents/rag_agent.py`](../../autobot-backend/agents/rag_agent.py)
