...
AUTOBOT_BROWSER_SERVICE_HOST=127.0.0.4 # Playwright/browser automation service
...
AUTOBOT_BROWSER_SERVICE_PORT=9001      # Playwright/browser automation service
AUTOBOT_VNC_PORT=6080                  # VNC web interface
