...
1. **Search existing endpoints**:
   ...
   grep -r "function_name\|endpoint_pattern" autobot-backend/api/
...
# Location: autobot-backend/utils/service_registry.py
...
python autobot-backend/agents/npu_code_search_agent.py --query "search_term"    # NPU code search
...
### Available Tools
- `autobot-backend/agents/npu_code_search_agent.py` - High-performance code searching
