...
**Location**: `autobot-backend/agents/kb_librarian_agent.py`  
...
**Location**: `autobot-backend/agents/containerized_librarian_assistant.py`
...
**Location**: `autobot-backend/agents/enhanced_kb_librarian.py`
...
**Location**: `autobot-backend/agents/system_knowledge_manager.py`
...
```python
# In autobot-backend/api/chat.py
...
- `autobot-frontend/tests/e2e/kb-librarian-api.spec.ts`: API endpoint tests
- `autobot-frontend/tests/e2e/kb-librarian-chat.spec.ts`: Chat integration tests
