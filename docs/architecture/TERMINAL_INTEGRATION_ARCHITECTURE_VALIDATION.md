...
|-----------|---------------|--------------|
| **xterm.js** | Installed (`autobot-frontend/node_modules/xterm`) | Not integrated - custom rendering used instead |
...
**Location:** `autobot-backend/api/terminal.py:line 210-239` (`send_to_terminal` method)
**Risk:** HIGH
...
**Location:** `autobot-backend/api/terminal.py:line 771-822` (WebSocket endpoint)
**Risk:** CRITICAL
...
**Location:** `autobot-backend/api/terminal.py:line 743-765` (audit endpoint)
**Risk:** MEDIUM
