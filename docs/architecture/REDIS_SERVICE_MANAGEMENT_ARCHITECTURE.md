...
2. `autobot-backend/api/service_management.py` - API router with endpoints
...
**Deliverables:**
1. `autobot-frontend/src/components/services/RedisServiceControl.vue`
2. `autobot-frontend/src/composables/useServiceManagement.js`
3. `autobot-frontend/src/services/RedisServiceAPI.js`
