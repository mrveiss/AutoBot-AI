...
**Backend:**
- VNC Manager: `autobot-backend/api/vnc_manager.py`
- Terminal: `autobot-backend/api/terminal.py`, `autobot-backend/api/terminal_handlers.py`
- Secrets: `backend/services/secrets_service.py`
- Terminal Secrets: `backend/services/terminal_secrets_service.py`

**Frontend:**
- Chat Interface: `autobot-frontend/src/components/chat/ChatInterface.vue`
- Chat Tab Content: `autobot-frontend/src/components/chat/ChatTabContent.vue`
- Chat Terminal: `autobot-frontend/src/components/ChatTerminal.vue`
- NoVNC Viewer: `autobot-frontend/src/components/NoVNCViewer.vue`
...
- `autobot-backend/api/infrastructure_hosts.py` (new)
...
- `autobot-backend/api/terminal.py` (modify)
- `autobot-backend/api/terminal_handlers.py` (modify)
...
**Files**:
- `autobot-frontend/src/components/HostSelector.vue` (new)
- `autobot-frontend/src/components/chat/ChatTabContent.vue`
- `autobot-frontend/src/components/ChatTerminal.vue`
- `autobot-frontend/src/services/TerminalService.js`
...
**Files**:
- `autobot-frontend/src/components/NoVNCViewer.vue`
...
**Files**:
- `autobot-frontend/src/components/settings/SecretsManager.vue`
- `autobot-frontend/src/components/settings/InfrastructureHostForm.vue` (new)
...
| `autobot-backend/api/infrastructure_hosts.py` | Create | Host listing and management endpoints |
...
| `autobot-backend/api/terminal.py` | Modify | Add SSH connection type support |
| `autobot-backend/api/terminal_handlers.py` | Modify | SSH WebSocket bridging |
| `autobot-backend/api/vnc_manager.py` | Modify | Dynamic VNC host support |
...
| File | Action | Description |
|------|--------|-------------|
| `autobot-frontend/src/components/HostSelector.vue` | Create | Reusable host dropdown |
| `autobot-frontend/src/components/chat/ChatTabContent.vue` | Modify | Add host selector to tabs |
| `autobot-frontend/src/components/chat/ChatInterface.vue` | Modify | Remove VNC startup check |
| `autobot-frontend/src/components/ChatTerminal.vue` | Modify | SSH connection support |
| `autobot-frontend/src/components/NoVNCViewer.vue` | Modify | Dynamic host/port |
| `autobot-frontend/src/services/TerminalService.js` | Modify | SSH session creation |
| `autobot-frontend/src/components/settings/SecretsManager.vue` | Modify | Infrastructure host type |
| `autobot-frontend/src/components/settings/InfrastructureHostForm.vue` | Create | Host configuration form |
