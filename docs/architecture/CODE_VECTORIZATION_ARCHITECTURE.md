...
# Collection: autobot_code_embeddings (SEPARATE from knowledge base)
{
    ...
    "metadata": {
        # File Information
        "file_path": "autobot-backend/api/analytics.py",
        "file_type": "python",  # python|javascript|vue
        "project_relative_path": "autobot-backend/api/analytics.py",
        ...
        "opportunities": [
            {
                ...
                "occurrences": 12,
                "files_affected": ["autobot-backend/api/chat.py", "autobot-backend/api/files.py", ...],
                "current_loc": 340,
...
1. Create `autobot-backend/api/code_vectorization.py`
