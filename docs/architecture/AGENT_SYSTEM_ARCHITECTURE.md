...
#### **Chat Agent (`autobot-backend/agents/chat_agent.py`)**
...
#### **KB Librarian Agent (`autobot-backend/agents/kb_librarian_agent.py`)**
...
#### **Enhanced System Commands Agent (`autobot-backend/agents/enhanced_system_commands_agent.py`)**
...
#### **RAG Agent (`autobot-backend/agents/rag_agent.py`)**
...
#### **Research Agent (`autobot-backend/agents/research_agent.py`)**
...
#### **Containerized Librarian Assistant (`autobot-backend/agents/containerized_librarian_assistant.py`)**
...
#### **Security Scanner Agent (`autobot-backend/agents/security_scanner_agent.py`)**
...
#### **Network Discovery Agent (`autobot-backend/agents/network_discovery_agent.py`)**
...
#### **Interactive Terminal Agent (`autobot-backend/agents/interactive_terminal_agent.py`)**
...
#### **Classification Agent (`autobot-backend/agents/classification_agent.py`)**
...
#### **Advanced Web Research (`autobot-backend/agents/advanced_web_research.py`)**
...
### **Agent Orchestrator (`autobot-backend/agents/agent_orchestrator.py`)**
...
#### **Base Agent Interface (`autobot-backend/agents/base_agent.py`)**
```python
class BaseAgent:
