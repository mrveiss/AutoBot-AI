...
### Critical Conflicts
1. **autobot-frontend/src/App.vue** - Core app component
2. **autobot-frontend/src/router/index.ts** - Router configuration
3. **autobot-frontend/src/assets/styles/theme.css** - Design system tokens
4. **backend/main.py** - Backend entry point
5. **644 autobot-backend/api/*.py files** - All API modules
...
```bash
git checkout main
git checkout Dev_new_gui -- autobot-frontend/src/components/ui/DarkModeToggle.vue
git checkout Dev_new_gui -- autobot-frontend/src/components/ui/PreferencesPanel.vue
git checkout Dev_new_gui -- autobot-frontend/src/views/SettingsView.vue
git checkout Dev_new_gui -- autobot-frontend/src/composables/usePreferences.ts
git checkout Dev_new_gui -- autobot-frontend/src/assets/styles/theme.css
