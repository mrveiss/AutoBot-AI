...
**Example from `autobot-backend/api/chat.py:66-79`:**
```python
...
**Example from `autobot-backend/api/chat.py:92-105`:**
```python
...
**BEFORE** (`autobot-backend/api/chat.py:66-79` - 14 lines):
```python
def get_chat_history_manager(request):
    """Lazy-initialize chat history manager on app state"""
    manager = getattr(request.app.state, "chat_history_manager", None)
...
|------|----------|-------------|
| `autobot-backend/api/chat.py:66` | `get_chat_history_manager()` | ~11 lines |
| `autobot-backend/api/chat.py:92` | `get_llm_service()` | ~11 lines |
| `autobot-backend/api/chat.py:120` | `get_knowledge_base()` | ~11 lines |
| `autobot-backend/api/chat.py:145` | `get_rag_service()` | ~11 lines |
| `autobot-backend/api/intelligence.py:45` | `get_intelligent_agent()` | ~11 lines |
| `autobot-backend/api/tools.py:38` | `get_tool_manager()` | ~11 lines |

### Priority 2 - Additional API Files

- `autobot-backend/api/memory.py` - Memory-related getters
- `autobot-backend/api/workflow.py` - Workflow getters
- `autobot-backend/api/agents.py` - Agent management getters
...
**Questions?** See:
- `autobot-backend/utils/lazy_singleton.py` - Utility implementation
