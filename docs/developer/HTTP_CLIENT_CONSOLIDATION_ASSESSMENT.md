...
**Key Files**:
- `autobot-backend/api/service_monitor.py` (4 imports)
- `autobot-backend/api/infrastructure_monitor.py`
- `autobot-backend/api/playwright.py`
...
- `autobot-backend/utils/service_discovery.py`
...
- `autobot-backend/tools/terminal_tool.py` (3 imports for authenticated calls)
...
**Files and Use Cases**:
1. **`autobot-backend/api/analytics.py`**
