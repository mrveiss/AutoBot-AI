...
| `AUTOBOT_WORKSPACE_BASE_REF` | orchestration | str | `'origin/Dev_new_gui'` | Ref that new task workspaces branch from (#15938). Distinct from AUTOBOT_GIT_BRANCH, which records the branch the running instance was built from: one describes this deployment, the other where new work starts. |
