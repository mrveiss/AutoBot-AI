...
| `lazy_singleton` | `autobot_shared/singleton_factory.py` | `lazy_singleton(factory) -> Callable` — double-checked locking; raises `RuntimeError` if called again with **different** args (#5445) | `utils/semantic_chunker.py`, `utils/semantic_chunker_gpu.py` | #5423 |
