...
### **Format Helpers** (`autobot-backend/utils/formatHelpers.ts`)
...
```bash
# Find empty states
grep -r "empty-state" autobot-frontend/src/components/

# Find modals
grep -r "dialog-overlay" autobot-frontend/src/components/

# Find status badges
grep -r "badge badge-" autobot-frontend/src/components/

# Find tables
grep -r "<table" autobot-frontend/src/components/
```
...
- **Location**: `autobot-frontend/src/components/infrastructure/DeploymentProgressModal.vue`
...
- **Location**: `autobot-frontend/src/components/PopoutChromiumBrowser.vue:205`
...
- **Location**: `autobot-frontend/src/components/infrastructure/HostCard.vue:18-20`
...
- **Lines Saved**: ~2 lines
- **Location**: `autobot-frontend/src/components/chat/ChatFilePanel.vue:123-130`
...
- **Lines Saved**: ~7 lines
- **Location**: `autobot-frontend/src/components/ResearchBrowser.vue`
...
- **Location**: `autobot-frontend/src/components/monitoring/MonitoringDashboard.vue`
...
- **Location**: `autobot-frontend/src/components/SecretsManager.vue`
...
- **Location**: `autobot-frontend/src/components/CommandPermissionDialog.vue`
...
- **Template Updates**: Line 28 replaced risk-badge with StatusBadge
- **Lines Saved**: ~28 lines
- **Location**: `autobot-frontend/src/components/ElevationDialog.vue`
...
- **Lines Saved**: ~17 lines
- **Location**: `autobot-frontend/src/components/knowledge/KnowledgeStats.vue`
...
- **Location**: `autobot-frontend/src/components/settings/NPUWorkersSettings.vue`
...
- **Location**: `autobot-frontend/src/components/ErrorBoundary.vue`
...
- **Location**: `autobot-frontend/src/components/async/AsyncErrorFallback.vue`
...
- **Location**: `autobot-frontend/src/components/PhaseStatusIndicator.vue`
...
- **Location**: `autobot-frontend/src/components/WorkflowApproval.vue`
...
- **Location**: `autobot-frontend/src/components/ManPageManager.vue`
...
**Files Modified**:
- `autobot-frontend/src/components/base/BaseButton.vue` (extended with touch features)
...
**New Component**: BaseAlert.vue (`autobot-frontend/src/components/ui/BaseAlert.vue`)
...
**1. BaseButton.vue** (`autobot-frontend/src/components/base/`)
...
**2. TouchFriendlyButton.vue** (`autobot-frontend/src/components/ui/`)
...
**3. StatusBadge.vue** (`autobot-frontend/src/components/ui/`)
...
**3. useToast Composable** (`autobot-frontend/src/composables/useToast.js`)
...
**Location**: `autobot-frontend/src/components/ui/TouchFriendlyButton.vue`
...
**Location**: `autobot-frontend/src/components/ui/StatusBadge.vue`
...
**Location**: `autobot-frontend/src/composables/useToast.js`
...
6. **Sync to frontend VM**:
   ```bash
   ./scripts/utilities/sync-to-vm.sh frontend autobot-frontend/src/components/YourComponent.vue /home/autobot/autobot-frontend/src/components/YourComponent.vue
   ```
...
- [Format Helpers Source](../../autobot-frontend/autobot-backend/utils/formatHelpers.ts)
- [UI Components Directory](../../autobot-frontend/src/components/ui/)
- [Base Components Directory](../../autobot-frontend/src/components/base/)
- [Composables Directory](../../autobot-frontend/src/composables/)
- [Shared Styles Directory](../../autobot-frontend/src/styles/)
