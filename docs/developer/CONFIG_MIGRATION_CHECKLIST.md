...
- [ ] Search for hardcoded IPs: `grep -rn "172\.16\.168\." autobot-frontend/src/`
- [ ] Search for hardcoded ports: `grep -rn ":[0-9]\{4,5\}" autobot-frontend/src/`
- [ ] Search for hardcoded URLs: `grep -rn "http://" autobot-frontend/src/`
