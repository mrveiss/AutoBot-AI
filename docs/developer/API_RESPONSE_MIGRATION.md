...
**Example from `autobot-backend/api/metrics.py:28`:**
```python
try:
...
**BEFORE** (`autobot-backend/api/metrics.py:68-75` - 8 lines):
```python
try:
...
|------|-----------|------------------|
| `autobot-backend/api/metrics.py` | 8 endpoints | ~40 lines |
| `autobot-backend/api/workflow.py` | 10+ endpoints | ~50 lines |
| `autobot-backend/api/feature_flags.py` | 5 endpoints | ~25 lines |
| `autobot-backend/api/scheduler.py` | 5 endpoints | ~25 lines |

### Priority 2 - Medium Impact

- `autobot-backend/api/multimodal.py` - 8 endpoints
- `autobot-backend/api/knowledge_mcp.py` - 9 endpoints
- `autobot-backend/api/templates.py` - 5 endpoints
- 10+ more files

### Priority 3 - Complex Patterns

- `autobot-backend/api/infrastructure.py` - 36 error patterns
- `autobot-backend/api/conversation_files.py` - 36 error patterns
- `autobot-backend/api/memory.py` - 40 error patterns
- 50+ more files
...
**Questions?** See:
- `autobot-backend/utils/api_responses.py` - Utility implementation
