...
| --- | --- |
| [ACCESS_CONTROL_ROLLOUT_RUNBOOK](ACCESS_CONTROL_ROLLOUT_RUNBOOK.md) | Access control rollout runbook |
...
| [DOC_INDEX_REBUILD](DOC_INDEX_REBUILD.md) | One-time autobot_docs collection rebuild after worktree contamination (#16934) |
