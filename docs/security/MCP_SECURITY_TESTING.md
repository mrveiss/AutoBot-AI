...
**Target:** Filesystem MCP (`autobot-backend/api/filesystem_mcp.py`)
...
**Target:** MCP Registry (`autobot-backend/api/mcp_registry.py`)
...
**Target:** Structured Thinking MCP (`autobot-backend/api/structured_thinking_mcp.py`)
...
```python
# File: autobot-backend/api/filesystem_mcp.py
...
- **Filesystem MCP Implementation:** `autobot-backend/api/filesystem_mcp.py`
- **MCP Registry:** `autobot-backend/api/mcp_registry.py`
