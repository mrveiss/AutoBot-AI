...
def main():
    ...
    print("  2. Run migration: python migrations/add_events_certificates_updates_tables.py")
...
if __name__ == "__main__":
    try:
        ...
        print("Make sure to run this script from the slm-server directory.", file=sys.stderr)
        sys.exit(1)
