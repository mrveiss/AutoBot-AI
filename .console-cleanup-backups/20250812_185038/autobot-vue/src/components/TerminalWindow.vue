<template>
  <div class="terminal-window-standalone">
    ...
    <div v-if="showCommandConfirmation" class="confirmation-modal-overlay" @click="cancelCommand">
    ...
    <div v-if="showKillConfirmation" class="confirmation-modal-overlay" @click="showKillConfirmation = false">
    ...
    <div v-if="showLegacyModal" class="confirmation-modal-overlay" @click="takeManualControl">
