  ...
  <div class="analytics-view">
    ...
    <div class="page-header">
      <div class="header-content">
        <h1><i class="fas fa-chart-line"></i> Analytics & Business Intelligence</h1>
        <p class="subtitle">Comprehensive analytics for tracking performance, costs, and system health</p>
      </div>
