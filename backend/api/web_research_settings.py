...
async def enable_web_research():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to enable web research: {str(e)}")
...
async def disable_web_research():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to disable web research: {str(e)}")
...
async def get_research_settings():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get research settings: {str(e)}")
...
async def update_research_settings(settings: WebResearchSettings):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to update research settings: {str(e)}")
...
async def clear_research_cache():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to clear research cache: {str(e)}")
