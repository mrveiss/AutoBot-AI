...
# NOTE: Tag-related models (AddTagsRequest, BulkTagRequest, etc.) moved to knowledge_tags.py
...
# Import vectorization router and helper (extracted from this file - Issue #185)
from backend.api.knowledge_vectorization import (
    router as vectorization_router,
