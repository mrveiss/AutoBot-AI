...
async def get_frontend_config():
    ...
    try:
        ...
        frontend_config = {
            "api": {
                "base_url": full_config.get("backend", {}).get("host", backend_config.get("host")),
                "port": full_config.get("backend", {}).get("port", backend_config.get("port")),
        ...
        default_config = {
            ...
            "features": {
                ...
                "knowledge_base_enabled": features_config.get("knowledge_base_enabled", True),
                "terminal_enabled": features_config.get("terminal_enabled", True),
                "desktop_enabled": features_config.get("desktop_enabled", True),
                "system_monitoring_enabled": features_config.get("system_monitoring_enabled", True)
            },
            "ui": {
