...
class RAGQueryRequest(BaseModel):
    ...
    documents: Optional[List[Dict[str, Any]]] = Field(None, description="Pre-retrieved documents")
...
class EnhancedChatRequest(BaseModel):
    ...
    chat_history: Optional[List[Dict[str, Any]]] = Field(None, description="Previous messages")
...
async def handle_ai_stack_error(error: AIStackError, context: str = "AI Stack operation"):
    ...
    try:
        ...
        return JSONResponse(
            ...
            content=create_success_response(
                health_status,
                "AI Stack health check completed"
            )
        )
    ...
    try:
        ...
        if request.use_knowledge_base and knowledge_base:
            try:
                ...
                kb_context = await knowledge_base.search(
        ...
        return create_success_response(
            chat_result,
            "Enhanced chat completed successfully"
        )
    except AIStackError as e:
...
async def enhanced_knowledge_search(
    ...
    try:
        ...
        return create_success_response(
            results,
            "Enhanced knowledge search completed"
        )
    except Exception as e:
...
async def get_system_knowledge(knowledge_category: Optional[str] = None):
    ...
    try:
        ...
        return create_success_response(
            result,
            "System knowledge retrieved successfully"
        )
    except AIStackError as e:
...
async def analyze_development_speedup(request: DevelopmentAnalysisRequest):
    ...
    try:
        ...
        return create_success_response(
            result,
            "Development speedup analysis completed successfully"
        )
    except AIStackError as e:
...
async def classify_content(request: ContentClassificationRequest):
    ...
    try:
        ...
        return create_success_response(
            result,
            "Content classification completed successfully"
        )
    except AIStackError as e:
