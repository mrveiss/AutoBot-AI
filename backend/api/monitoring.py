...
class HardwareMonitor:
    ...
    def get_gpu_status():
        ...
        try:
            ...
            return {
                "available": dashboard.get("hardware_acceleration", {}).get("gpu_available", False),
                ...
                "status": "healthy" if gpu_data.get("utilization_percent", 0) > 0 else "idle"
            }
        except Exception as e:
    ...
    def get_npu_status():
        ...
        try:
            ...
            return {
                "available": dashboard.get("hardware_acceleration", {}).get("npu_available", False),
                ...
                "status": "healthy" if npu_data.get("utilization_percent", 0) > 0 else "idle"
            }
        except Exception as e:
