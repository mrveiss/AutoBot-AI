...
FEATURE_ROUTER_CONFIGS: List[Tuple[str, str, List[str], str]] = [
    ...
    ("backend.api.llm_optimization", "/llm-optimization", ["llm-optimization"], "llm_optimization"),
    ("backend.api.llm_awareness", "/llm-awareness", ["llm-awareness"], "llm_awareness"),
    # Web research and browser automation
    ("backend.api.research_browser", "/research-browser", ["research-browser"], "research_browser"),
    ("backend.api.playwright", "/playwright", ["playwright"], "playwright"),
    ("backend.api.vision", "/vision", ["vision", "gui-automation"], "vision"),
    ("backend.api.web_research_settings", "/web-research-settings", ["web-research-settings"], "web_research_settings"),
    ("backend.api.captcha", "", ["captcha", "web-research"], "captcha"),
    # State and project management
    ("backend.api.state_tracking", "/state-tracking", ["state-tracking"], "state_tracking"),
    ...
    ("backend.api.code_intelligence", "/code-intelligence", ["code-intelligence", "code-analysis"], "code_intelligence"),
    ("backend.api.natural_language_search", "", ["natural-language-search", "code-search"], "natural_language_search"),
    ("backend.api.ide_integration", "/ide", ["ide", "code-intelligence", "real-time"], "ide_integration"),
    # Orchestration and caching
    ("backend.api.orchestration", "/orchestration", ["orchestration"], "orchestration"),
    ("backend.api.cache_management", "/cache-management", ["cache-management"], "cache_management"),
    # Enhanced features
    ("backend.api.enhanced_search", "/enhanced-search", ["enhanced-search"], "enhanced_search"),
    ("backend.api.enhanced_memory", "/enhanced-memory", ["enhanced-memory"], "enhanced_memory"),
    ("backend.api.development_speedup", "/dev-speedup", ["dev-speedup"], "development_speedup"),
    ("backend.api.advanced_control", "/advanced-control", ["advanced-control"], "advanced_control"),
    # Long-running and validation
    ("backend.api.long_running_operations", "/long-running", ["long-running"], "long_running_operations"),
    ("backend.api.system_validation", "/system-validation", ["system-validation"], "system_validation"),
    ...
    ("backend.api.knowledge_search_unified", "/knowledge", ["knowledge-unified", "documentation"], "knowledge_search_unified"),  # Issue #708: renamed from knowledge_unified
...
def load_feature_routers() -> List[Tuple]:
    ...
    logger.info("📊 Loaded %s/%s feature routers", len(optional_routers), len(FEATURE_ROUTER_CONFIGS))
