...
def verify_no_duplicate_code():
    ...
    assert "from src.utils.common import PathUtils" in async_content, "Async memory manager should import PathUtils"
    assert "from src.utils.common import PathUtils" in sync_content, "Sync memory manager should import PathUtils"
