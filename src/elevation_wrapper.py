...
ELEVATION_REQUIRED_COMMANDS = [
    ...
    'usermod', 'groupmod', 'passwd', 'chown', 'chmod',
...
class ElevationWrapper:
    ...
    async def execute_command(self, command: str, operation: str = None, 
                            reason: str = None, risk_level: str = "MEDIUM") -> Dict:
        ...
        if not operation:
            operation = f"Execute system command"
        if not reason:
