...
class TerminalTool:
    ...
    def _parse_agent_role(self, agent_role: str):
        ...
        try:
            ...
            return None, {"status": "error", "error": f"Invalid agent role: {agent_role}"}
    ...
    async def create_session(
        self, agent_id: str, conversation_id: str, agent_role: str = "chat_agent", host: str = "main"
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            session = await self.agent_terminal_service.create_session(
                agent_id=agent_id, agent_role=role_enum, conversation_id=conversation_id, host=host
            )
    ...
    def _format_execution_result(self, result: Dict[str, Any], command: str, description: Optional[str]) -> Dict[str, Any]:
    ...
    async def get_user_command_history(self, conversation_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not user_sessions:
                return {"status": "success", "history": [], "message": "No active user terminal session found"}
