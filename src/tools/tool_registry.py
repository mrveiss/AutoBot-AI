...
class ToolRegistry:
    ...
    def __init__(self, worker_node: Optional['WorkerNode'] = None, knowledge_base: Optional['KnowledgeBase'] = None):
        """
    ...
    async def manage_service(self, service_name: str, action: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "result": result.get("output", result.get("message", f"Service {service_name} {action} completed")),
            "status": result.get("status", "success")
        }
        ...
        try:
            ...
            if results:
                ...
                for result in results:
                    ...
                    formatted_results.append(f"[{filename} - Chunk {chunk_index}]: {content_preview}")
    ...
    async def add_file_to_knowledge_base(self, file_path: str, file_type: str, metadata: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "tool_name": "add_file_to_knowledge_base",
                "tool_args": {"file_path": file_path, "file_type": file_type, "metadata": metadata},
    ...
    async def click_element(self, image_path: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "result": result.get("output", result.get("message", f"Clicked element: {image_path}")),
            "status": result.get("status", "success")
        }
    ...
    async def bring_window_to_front(self, window_title: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "result": result.get("output", result.get("message", f"Brought window to front: {window_title}")),
            "status": result.get("status", "success")
        }
