...
class HardwareAccelerationManager:
    ...
    def __init__(self):
        ...
        self.device_priorities = [AccelerationType.NPU, AccelerationType.GPU, AccelerationType.CPU]
        self.current_config = {}
    ...
    def _detect_available_hardware(self):
        ...
        logger.info(f"Hardware detection complete - NPU: {self.npu_available}, GPU: {self.gpu_available}, CPU: Available")
    ...
    def _get_cpu_info(self) -> Dict[str, Any]:
        ...
        try:
            cpu_info = {
                ...
                "recommended_models": ["1b", "3b", "tiny"],  # CPU suitable for all models
                "memory_efficient": True,
                "power_efficient": True,
