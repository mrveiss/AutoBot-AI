    ...
    def _load_default_config(self) -> Dict[str, Any]:
        ...
        return {
            "backend": {
                ...
                "streaming": False,
                "cors_origins": [
                    f"http://{os.getenv('AUTOBOT_FRONTEND_HOST')}:{os.getenv('AUTOBOT_FRONTEND_PORT')}",
                    f"http://{os.getenv('AUTOBOT_BROWSER_SERVICE_HOST')}:{os.getenv('AUTOBOT_BROWSER_SERVICE_PORT')}",
                ],
            },
            "frontend": {
            ...
            "infrastructure": {
                ...
                "protocols": {"default": "http", "secure": "https"},
            },
            "llm": {
                "provider_type": "local",
                "local": {
                    ...
                    "providers": {
                        "ollama": {
                            ...
                            "selected_model": os.getenv("AUTOBOT_DEFAULT_LLM_MODEL", "llama3.2:1b"),
                            "classification_model": os.getenv("AUTOBOT_CLASSIFICATION_MODEL", "llama3.2:1b"),
                            "models": [],
                        }
                    },
                },
