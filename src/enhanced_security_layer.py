...
class EnhancedSecurityLayer:
    ...
    def __init__(self):
        ...
        print(f"EnhancedSecurityLayer initialized.")
    ...
    def check_permission(self, user_role: str, action_type: str, 
        ...
        print(f"Permission DENIED for role '{user_role}' to perform action '{action_type}'")
        return False
    ...
    async def execute_command(self, command: str, user: str, 
    ...
    def audit_log(self, action: str, user: str, outcome: str, 
    ...
    def get_command_history(self, user: Optional[str] = None, 
            ...
            with open(self.audit_log_file, "r") as f:
                for line in f:
                    try:
                        ...
                        if entry["action"] in ["command_execution_attempt", 
...
if __name__ == "__main__":
    async def test_security():
        ...
        for entry in history:
            print(f"- {entry['timestamp']}: {entry['user']} - {entry['action']} - {entry['outcome']}")
