...
class DomainReputationService:
    ...
    def __init__(self, config_path: str = "/home/kali/Desktop/AutoBot/config/security/domain_security.yaml"):
    ...
    def _is_suspicious_domain(self, domain: str) -> bool:
        ...
        suspicious_indicators = [
            ...
            any(char.isdigit() for char in domain.split('.')[0]) and len(domain.split('.')[0]) > 8,  # Long subdomain with numbers
    ...
    def _is_service_enabled(self, service_name: str) -> bool:
        ...
        return (service_config.get("enabled", False) and 
