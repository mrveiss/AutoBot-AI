...
class PatternAnalysisReport:
    ...
    def to_markdown(self) -> str:
        ...
        md = []
        md.append("# Code Pattern Analysis Report")
        md.append("")
        md.append("## Summary")
        md.append(f"- **Path Analyzed:** `{self.scan_path}`")
        md.append(f"- **Files Analyzed:** {self.total_files_analyzed}")
        md.append(f"- **Lines Analyzed:** {self.total_lines_analyzed:,}")
        md.append(f"- **Patterns Found:** {self.total_patterns}")
        md.append(f"- **Potential LOC Reduction:** {self.potential_loc_reduction}")
        md.append(f"- **Complexity Score:** {self.complexity_score}")
        md.append("")

        # Duplicate Patterns
        if self.duplicate_patterns:
            md.append("## Duplicate Patterns")
            md.append("")
        ...
        # Regex Opportunities
        if self.regex_opportunities:
            md.append("## Regex Optimization Opportunities")
            md.append("")
        ...
        # Complexity Hotspots
        if self.complexity_hotspots:
            md.append("## Complexity Hotspots")
            md.append("")
            md.append("| Location | CC | MI | Suggestions |")
            md.append("|----------|----|----|-------------|")
            for ch in sorted(
                self.complexity_hotspots,
        ...
        if self.modularization_suggestions:
            md.append("## Modularization Suggestions")
            md.append("")
