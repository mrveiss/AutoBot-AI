...
from .llm_providers import VLLMProvider, VLLMModelManager, RECOMMENDED_MODELS
...
class ExtendedLLMInterface(LLMInterface):
    ...
    async def chat_completion(
        ...
        **kwargs
        ...
        try:
            ...
            logger.debug(f"Using provider: {selected_provider}, model: {selected_model}")
    ...
    def _get_default_provider_for_type(self, llm_type: Optional[str]) -> tuple[str, str]:
        ...
        models_info = {
            ...
            "provider_routing": {
                ...
                for llm_type, (provider, model) in {
                    ...
                    "classification": self._get_default_provider_for_type("classification"),
                    "system_commands": self._get_default_provider_for_type("system_commands"),
    ...
    async def get_model_performance_stats(self) -> Dict[str, Any]:
        ...
        stats = {
            ...
            "active_models": len([
                m for m in self.vllm_manager.list_models().values() 
                if m["loaded"]
            ])
        }
