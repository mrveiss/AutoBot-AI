...
async def monitor_gpu_acceleration_efficiency(
    ...
    try:
        ...
        util_efficiency = calculate_utilization_efficiency(gpu_metrics)
        mem_efficiency = calculate_memory_efficiency(gpu_metrics)
        ...
        efficiency_report["efficiency_scores"] = {
            "utilization_efficiency": util_efficiency,
        ...
        efficiency_report["overall_efficiency"] = (
            util_efficiency * 0.3
            + mem_efficiency * 0.25
        ...
        logger.error(f"GPU efficiency monitoring failed: {e}")
