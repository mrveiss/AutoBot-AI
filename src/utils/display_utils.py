...
class DisplayDetector:
        ...
        try:
            ...
            if result.returncode == 0:
                for line in result.stdout.split('\n'):
                    if '*' in line and '+' in line:  # Current mode with * and preferred with +
    ...
    def _detect_windows_resolution(self) -> Tuple[int, int]:
        ...
        try:
            ...
            return self.fallback_resolution
        except (subprocess.TimeoutExpired, subprocess.SubprocessError, json.JSONDecodeError, ImportError):
            return self.fallback_resolution
