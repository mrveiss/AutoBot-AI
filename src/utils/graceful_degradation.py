...
class GracefulDegradationManager:
    ...
    def _update_service_health(self):
        ...
        logger.info(f"Service health updated: {self.service_status.health.value} "
    ...
    async def _perform_health_check(self):
        ...
        # Log health status
        logger.debug(f"Health check: {self.service_status.health.value} "
...
async def create_degradation_manager(cache_dir: str = "data/cache/claude_responses") -> GracefulDegradationManager:
