...
class AsyncFileOperations:
    ...
    async def create_temp_file(self, content: str, suffix: str = '.tmp', 
                              prefix: str = 'autobot_') -> Optional[str]:
        """
...
async def write_file_async(file_path: Union[str, Path], content: str, 
