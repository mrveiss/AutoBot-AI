...
class AgentOrchestrator:
    ...
    def _initialize_agent_capabilities(self) -> Dict[AgentType, AgentCapability]:
        ...
        return {
            AgentType.CHAT: AgentCapability(
                ...
                strengths=["Quick responses", "Natural conversation", "Simple Q&A", "Greetings"],
                limitations=["Complex reasoning", "Multi-step tasks", "Technical analysis"],
                resource_usage="Low"
            ),
            AgentType.SYSTEM_COMMANDS: AgentCapability(
                ...
                strengths=["Shell commands", "System operations", "Security validation", "Command explanation"],
            ...
            AgentType.RAG: AgentCapability(
                ...
                strengths=["Information synthesis", "Document analysis", "Query reformulation", "Context ranking"],
            ...
            AgentType.KNOWLEDGE_RETRIEVAL: AgentCapability(
                ...
                strengths=["Quick searches", "Database queries", "Vector lookups", "Simple retrieval"],
            ...
            AgentType.RESEARCH: AgentCapability(
                ...
                strengths=["Multi-step research", "Data extraction", "Source validation", "Web scraping"],
    ...
    async def process_request(
        ...
        try:
            ...
            if routing_decision["strategy"] == "single_agent":
                ...
                return await self._execute_orchestrator_fallback(request, context, chat_history)
    ...
    def _quick_route_analysis(self, request: str) -> Dict[str, Any]:
        ...
        if any(pattern in request_lower for pattern in 
               ["run", "execute", "command", "system", "shell", "terminal", "ps", "ls", "df"]):
            return {
                "strategy": "single_agent",
        ...
        # Research patterns
        if any(pattern in request_lower for pattern in 
               ["search web", "research", "find online", "latest", "current", "recent"]):
            return {
        ...
        if any(pattern in request_lower for pattern in 
               ["according to", "based on documents", "analyze", "summarize"]):
            return {
                "strategy": "multi_agent",
    ...
    async def _execute_single_agent(
        ...
        try:
            if agent_type == AgentType.CHAT:
                ...
                result = await agent.process_chat_message(request, context, chat_history)
