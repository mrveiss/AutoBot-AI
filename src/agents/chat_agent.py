...
For complex technical tasks, analysis, or system commands, you should indicate that specialized agents can handle those better."""
    ...
    def is_chat_appropriate(self, message: str) -> bool:
        ...
        chat_patterns = [
            ...
            "tell me about", "explain", "what is", "who is", "where is", "when",
            "help", "please", "can you", "would you", "could you"
        ]
        
        # Complex task patterns that should be routed elsewhere
        complex_patterns = [
            "execute", "run command", "system", "install", "download",
            "search knowledge", "find documents", "research", "web search",
            "analyze", "calculate", "compute", "code", "script", "program"
        ]
