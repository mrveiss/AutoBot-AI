 ...
 *
 * Barrel exports for CodebaseAnalytics sub-components.
...
export { default as CodebaseOverviewPanel } from './CodebaseOverviewPanel.vue'
export { default as CodebaseDependenciesPanel } from './CodebaseDependenciesPanel.vue'
export { default as CodebaseSecurityPanel } from './CodebaseSecurityPanel.vue'
