...
<!-- Author: mrveiss -->
<template>
  <div class="presets-settings-panel">
    <!-- Error banner -->
    ...
    >
      ...
      <div class="form-field">
        <label for="settings-preset-name" class="field-label">{{ $t('chat.presets.fieldName') }}</label>
        <input
          ...
          :aria-describedby="nameError ? 'settings-preset-name-error' : undefined"
          @input="nameError = ''"
        />
        <span v-if="nameError" id="settings-preset-name-error" class="field-error">{{ nameError }}</span>
      </div>

      <div class="form-field">
        <label for="settings-preset-description" class="field-label">{{ $t('chat.presets.fieldDescription') }}</label>
        <input
          id="settings-preset-description"
      ...
      <div class="form-field">
        <label for="settings-preset-content" class="field-label">{{ $t('chat.presets.fieldContent') }}</label>
        <textarea
          id="settings-preset-content"
          v-model="form.content"
          class="field-textarea"
          rows="4"
          :placeholder="$t('chat.presets.contentPlaceholder')"
          :aria-invalid="!!contentError"
          :aria-describedby="contentError ? 'settings-preset-content-error' : undefined"
          @input="contentError = ''"
        />
        <span v-if="contentError" id="settings-preset-content-error" class="field-error">{{ contentError }}</span>
      </div>
