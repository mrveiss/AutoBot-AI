<template>
  <div class="chromium-browser-container">
    ...
    <div v-if="markRegionsMode && showAiGoalInput" class="flex items-center gap-2 px-3 py-2 border-b" style="border-color: var(--border-default); background: var(--bg-secondary)">
      <input
        v-model="aiGoalText"
        type="text"
