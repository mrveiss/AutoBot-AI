...
const modeOptions = computed(() => [
  {
    ...
    details: [
      { type: 'neutral', icon: 'times' as const, text: t('featureFlags.modeSelector.modeDisabledDetail1') },
      { type: 'neutral', icon: 'times' as const, text: t('featureFlags.modeSelector.modeDisabledDetail2') },
      { type: 'neutral', icon: 'times' as const, text: t('featureFlags.modeSelector.modeDisabledDetail3') },
    ],
  },
  {
    ...
    details: [
      { type: 'success', icon: 'check' as const, text: t('featureFlags.modeSelector.modeLogOnlyDetail1') },
      { type: 'success', icon: 'check' as const, text: t('featureFlags.modeSelector.modeLogOnlyDetail2') },
      { type: 'warning', icon: 'times' as const, text: t('featureFlags.modeSelector.modeLogOnlyDetail3') },
    ],
  },
  {
    ...
    details: [
      { type: 'success', icon: 'check' as const, text: t('featureFlags.modeSelector.modeEnforcedDetail1') },
      { type: 'success', icon: 'check' as const, text: t('featureFlags.modeSelector.modeEnforcedDetail2') },
      { type: 'error', icon: 'ban' as const, text: t('featureFlags.modeSelector.modeEnforcedDetail3') },
    ],
  },
]);
