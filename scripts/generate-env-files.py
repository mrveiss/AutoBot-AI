...
def generate_main_env(config):
    ...
    content = [
        ...
        f"AUTOBOT_DEPLOYMENT_MODE=hybrid",
        f"AUTOBOT_DEBUG=true",
...
def generate_frontend_env(config):
    ...
    content = [
        ...
        f"VITE_HTTP_PROTOCOL=http",
        f"VITE_WS_PROTOCOL=ws",
        "",
        ...
        f"VITE_UPLOAD_TIMEOUT=300000",
        f"VITE_DEFAULT_PAGE_SIZE=20",
        f"VITE_MAX_SEARCH_RESULTS=50",
        "",
        "# Development Settings",
        f"VITE_ENV=development",
