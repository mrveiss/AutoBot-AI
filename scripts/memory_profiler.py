...
class MemoryProfiler:
    ...
    def get_system_memory_info(self) -> Dict[str, Any]:
        ...
        logger.info(f"💾 System Memory: {system_info['virtual_memory']['used_gb']}GB used / {system_info['virtual_memory']['total_gb']}GB total ({system_info['virtual_memory']['percentage']:.1f}%)")
    ...
    def get_process_memory_info(self) -> Dict[str, Any]:
        ...
        logger.info(f"⚡ Process Memory: {process_info['rss_mb']}MB RSS, {process_info['vms_mb']}MB VMS ({process_info['percentage']:.1f}%)")
    ...
    def analyze_large_files(self) -> Dict[str, Any]:
        ...
        directories_to_check = [
            "src/", "backend/", "data/", "reports/", "autobot-vue/",
            "logs/", "cache/", "temp/", ".git/"
        ]
        ...
        logger.info(f"📂 Files: {file_count:,} total files, {file_analysis['total_size_gb']}GB total, {len(large_files)} files >1MB")
...
"""
    ...
    def run_full_profile(self):
        ...
        logger.info(f"🖥️  System Memory: {system_mem['used_gb']}GB / {system_mem['total_gb']}GB ({system_mem['percentage']:.1f}%)")
