...
class CodebaseProfiler:
    ...
    def analyze_static_patterns(self) -> Dict[str, Any]:
        ...
        actual_duplicates = {
            name: files for name, files in patterns["duplicate_functions"].items()
            if len(files) > 1
        }
    ...
    def run_comprehensive_analysis(self) -> Dict[str, Any]:
        ...
        print(f"🔥 High complexity functions: {len(self.results['performance_hotspots'].get('high_complexity_functions', []))}")
