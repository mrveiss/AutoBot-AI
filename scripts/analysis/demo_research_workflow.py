...
def demo_research_workflow():
    ...
    print("AutoBot: I don't have specific knowledge about this topic in my knowledge base.")
    print("         Do you want me to research this topic? (yes/no)")
    print("         If you answer 'no', I'll end this workflow here.")
    print("         If you answer 'yes', I can help research this topic with your guidance.")
    print()

    print("Scenario 2: User says 'yes' to research")
    print("User: 'yes'")
    print("AutoBot: Great! I'll help you research this topic. Please provide more details")
    ...
    print("User: 'no'")
    print("AutoBot: Understood. I don't have information about this topic in my knowledge")
    ...
    print("         provide information from my local knowledge base and documentation files.")
    print()
