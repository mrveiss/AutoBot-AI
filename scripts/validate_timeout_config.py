...
def test_environment_aware_access(config: UnifiedConfigManager):
    ...
    test_cases = [
        # Redis operations
        ("redis.operations", "get", "production", 0.5, "Redis GET - Production (strict)"),
        ("redis.operations", "get", "development", 1.0, "Redis GET - Development (lenient)"),
        ("redis.operations", "scan_iter", "development", 30.0, "Redis SCAN_ITER - Development (override)"),

        # LlamaIndex
        ("llamaindex.search", "query", "production", 5.0, "LlamaIndex Query - Production (strict)"),
        ("llamaindex.search", "query", "development", 20.0, "LlamaIndex Query - Development (override)"),

        # Documents
        ("documents.operations", "add_document", None, 30.0, "Add Document - Default environment"),
    ]
