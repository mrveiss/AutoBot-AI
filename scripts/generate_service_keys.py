...
async def generate_keys():
    ...
    print()
    print("Next steps:")
    print("  1. Deploy keys to VMs: ansible-playbook ansible/playbooks/deploy-service-auth.yml")
    print("  2. Verify deployment: ansible all -m shell -a 'ls -la /etc/autobot/service-keys/'")
    print(f"  3. Backup location: {backup_file}")
    print()
    print("⚠️  SECURITY: Keep backup file secure and delete after deployment verification")
