...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('/home/kali/Desktop/AutoBot/logs/database/memory_graph_init.log', mode='a')
    ]
)
...
class MemoryGraphInitializer:
    ...
    def migrate_conversations(self, transcript_dir: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            if not transcript_files:
                ...
                return {"status": "success", "entities_created": 0, "relations_created": 0}
    ...
    def _conversation_to_entity(self, transcript_path: Path) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            topic_keywords = [
                'redis', 'database', 'frontend', 'backend', 'api',
                'vue', 'python', 'docker', 'chromadb', 'npu',
                'deployment', 'security', 'training', 'knowledge base',
                'autobot', 'vm', 'distributed', 'memory graph'
            ]
            ...
            for msg in messages:
                ...
                decision_markers = ['DECISION:', 'FIX:', 'IMPLEMENTED:', 'RESOLVED:', 'CONFIGURED:']
    ...
    def _write_entities_and_relations(self, entities: List[Dict[str, Any]], relations: List[Dict[str, Any]]) -> Dict[str, Any]:
...
def main():
    ...
    try:
        ...
        if args.migrate:
            ...
            transcript_dir = Path("/home/kali/Desktop/AutoBot/data/conversation_transcripts")
