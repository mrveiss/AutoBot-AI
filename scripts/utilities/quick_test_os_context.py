...
from src.utils.system_context import get_system_context, generate_unique_key
...
async def main():
    ...
    result = await kb.store_fact(
        content="Test man page with OS context",
    ...
    if result.get('status') == 'success':
        ...
        if fact:
            ...
            required_fields = ['machine_id', 'machine_ip', 'os_name', 'os_version',
                               'os_type', 'architecture', 'kernel_version', 'unique_key']
