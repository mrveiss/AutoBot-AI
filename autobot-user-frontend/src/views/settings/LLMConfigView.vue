...
<template>
  <div class="p-6 space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h2 class="text-2xl font-bold text-gray-900">LLM Configuration</h2>
    ...
    <div class="mt-6">
      ...
      <div v-show="activeTab === 'providers'">
        ...
        <div v-else-if="providers.length === 0" class="text-center py-12">
          ...
          <p class="mt-1 text-sm text-gray-500">Get started by configuring an LLM provider.</p>
        </div>
    ...
    >
      <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
        <div class="flex items-center justify-between mb-4">
          <h3 class="text-lg font-semibold text-gray-900">Configure Provider</h3>
          <button
