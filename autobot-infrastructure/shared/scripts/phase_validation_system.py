...
class PhaseValidator:
    ...
    def _get_feature_validators(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "container_security": lambda: any((root / _SHARED_SCRIPTS).glob("*security*")),
            ...
            "terminal_interface": lambda: any((root / "autobot-frontend/src/components").rglob("*Terminal*")),
            "settings_panel": lambda: any((root / "autobot-frontend/src/components").rglob("*Settings*")),
            ...
            "unit_testing": lambda: (root / "autobot-backend/tests").exists(),
            ...
            "code_quality_checks": lambda: any((root / _SHARED_SCRIPTS).glob("*profile*")),
