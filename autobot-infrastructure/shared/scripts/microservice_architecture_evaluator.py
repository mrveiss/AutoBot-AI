...
class MicroserviceArchitectureEvaluator:
    ...
    def analyze_project_structure(self) -> Dict[str, Any]:
        ...
        key_directories = ["src/", "backend/", "autobot-vue/", "scripts/", "config/"]
    ...
    def _analyze_api_endpoints(self) -> Dict[str, Any]:
        ...
        endpoints = {"routers": [], "endpoint_groups": {}, "total_endpoints": 0}
    ...
    def _extract_routes(self, content: str, router_info: Dict[str, Any]) -> None:
        ...
        for method, path in routes:
            router_info["endpoints"].append({"method": method.upper(), "path": path})
    ...
    def _analyze_data_models(self) -> Dict[str, Any]:
        ...
        models = {"database_files": [], "model_classes": [], "database_types": set()}
    ...
    def _analyze_agents(self) -> Dict[str, Any]:
        ...
        agents = {"agent_files": [], "agent_types": {}, "total_agents": 0}
    ...
    def _analyze_utilities(self) -> Dict[str, Any]:
        ...
        utilities = {"util_files": [], "shared_utilities": [], "utility_types": {}}
    ...
    def _analyze_services(self) -> Dict[str, Any]:
        ...
        services = {"service_files": [], "service_types": {}, "total_services": 0}
    ...
    def analyze_dependencies(self) -> Dict[str, Any]:
        ...
        logger.info(
            "🔄 Found %s potential circular dependencies",
            len(dependencies["circular_dependencies"]),
        )
    ...
    def identify_service_boundaries(self) -> Dict[str, Any]:
        ...
        for db_type in models.get("database_types", []):
            service = {
                ...
                "responsibilities": [
                    f"Manage {db_type} data operations",
                    "Data validation",
                    "Query optimization",
                ],
            }
    ...
    def generate_recommendations(self) -> List[str]:
        ...
        if total_services >= 6:
            recommendations.append(
                f"✅ GOOD CANDIDATE: Identified {total_services} potential services - suitable for microservices"
            )
        elif total_services >= 3:
            recommendations.append(
                f"🟡 MODERATE: Identified {total_services} potential services - consider selective extraction"
            )
        else:
            recommendations.append(
                "🔴 WARNING: Few clear service boundaries identified - reconsider microservices approach"
            )
        ...
        if high_coupling_count > 5:
            recommendations.append(
                f"⚠️  HIGH COUPLING: {high_coupling_count} highly coupled modules - refactor before migration"
            )

        circular_deps = len(dependencies["circular_dependencies"])
        if circular_deps > 0:
            recommendations.append(
                f"🔄 CIRCULAR DEPENDENCIES: {circular_deps} detected - must resolve before migration"
            )
