...
show_menu() {
    ...
    echo "1. VM1 - Frontend (${AUTOBOT_FRONTEND_HOST:-localhost})"
    echo "2. VM2 - NPU Worker (${AUTOBOT_NPU_WORKER_HOST:-localhost})"
    echo "3. VM3 - Redis (${AUTOBOT_REDIS_HOST:-localhost})"
    echo "4. VM4 - AI Stack (${AUTOBOT_AI_STACK_HOST:-localhost})"
    echo "5. VM5 - Browser (${AUTOBOT_BROWSER_SERVICE_HOST:-localhost})"
