...
echo -e "  ✅ ${GREEN}ONLY ${AUTOBOT_FRONTEND_HOST:-localhost}:${AUTOBOT_FRONTEND_PORT:-5173} runs the frontend (Frontend VM)${NC}"
echo -e "  ❌ ${RED}NO frontend servers on main machine (${AUTOBOT_BACKEND_HOST:-localhost})${NC}"
...
echo "1. Edit code locally in: /home/kali/Desktop/AutoBot/autobot-slm-frontend/"
