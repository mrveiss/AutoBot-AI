...
<template>
  <div class="min-h-screen bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center">
    <div class="text-center">
      ...
      <p class="text-white text-lg">{{ $t('sSOCallbackView.completingSSOLogin') }}</p>
    </div>
  </div>
</template>
