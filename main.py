...
The production backend is now at: autobot-backend/main.py

To start the backend:
    cd autobot-backend && uvicorn main:app --host 0.0.0.0 --port 8001
...
warnings.warn(
    ...
    "Use 'cd autobot-backend && uvicorn main:app' instead.\n"
