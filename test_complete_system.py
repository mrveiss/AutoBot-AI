                    ...
                    if result.get('workflow_id'):
                        ...
                        async with session.get(
                            ...
                            if status_response.status == 200:
                                ...
                                print(f"   Steps: {status.get('current_step', 0)}/{status.get('total_steps', 0)}")
                            else:
                                print(f"❌ Workflow status API failed: {status_response.status}")
...
async def demonstrate_workflow_vs_generic():
    ...
    print("   'Port Scanner, Sniffing Software, Password Cracking Tools, Reconnaissance Tools'")
