...
class LongRunningOperation:
    ...
    def get_timeout_seconds(self) -> float:
        ...
        return LongRunningTimeoutConfig.get_timeout_config(self.operation_type)["timeout_seconds"]

    def get_checkpoint_interval(self) -> float:
        """Get checkpoint interval for this operation type."""
        return LongRunningTimeoutConfig.get_timeout_config(self.operation_type)["checkpoint_interval"]
