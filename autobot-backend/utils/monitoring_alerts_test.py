...
async def test_monitoring_alerts():
    ...
    try:
        from utils.monitoring_alerts import AlertRule, AlertSeverity, get_alerts_manager
        ...
        if high_cpu_rule:
            ...
            from utils.monitoring_alerts import Alert, AlertStatus
        ...
        if log_channel and log_channel.enabled:
            from utils.monitoring_alerts import Alert, AlertSeverity, AlertStatus
