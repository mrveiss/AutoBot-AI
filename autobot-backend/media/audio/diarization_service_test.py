...
class TestDiarizationService:
    ...
    async def test_diarize_pyannote_not_available(self):
        ...
        with patch(
            "media.audio.diarization_service._pyannote_available", False
        ):
    ...
    async def test_diarize_success(self):
        ...
        try:
            ...
            with patch(
                "media.audio.diarization_service._pyannote_available", True
            ):
    ...
    async def test_diarize_with_speaker_constraints(self):
        ...
        try:
            ...
            with patch(
                ...
                segments = await self.service.diarize(
                    audio_path, min_speakers=2, max_speakers=4
                )
    ...
    async def test_diarize_error_handling(self):
        ...
        try:
            ...
            mock_pipeline = MagicMock(
                side_effect=Exception("Diarization processing error")
            )
