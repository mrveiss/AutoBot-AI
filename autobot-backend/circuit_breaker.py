...
def circuit_breaker_async(
    ...
    def decorator(func):
        ...
        circuit_breaker = get_circuit_breaker_manager().get_circuit_breaker(service_name, config)
...
async def protected_database_call(func: Callable, *args, **kwargs) -> Any:
    ...
    circuit_breaker = get_circuit_breaker_manager().get_circuit_breaker("database_service", config)
    return await circuit_breaker.call_async(func, *args, **kwargs)
...
async def protected_network_call(func: Callable, *args, **kwargs) -> Any:
    ...
    circuit_breaker = get_circuit_breaker_manager().get_circuit_breaker("network_service", config)
    return await circuit_breaker.call_async(func, *args, **kwargs)
