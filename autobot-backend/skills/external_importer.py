...
class ExternalSkillImporter:
    ...
    async def import_git_repo(self, url: str, ref: str = "main", repo_id: str | None = None) -> list[SkillPackage]:
        ...
        if os.path.exists(os.path.join(clone_dir, ".git")):
            ...
            await _run_git("clone", "--depth=1", "--branch", ref, url, clone_dir)  # codeql[py/full-ssrf] SSRF mitigated: url validated by _validate_git_url() enforcing https/ssh scheme and blocking private IP ranges
