...
"""
    ...
    def _report_recommendations(self) -> str:
...
"""
    ...
    def _report_error_summary(self) -> str:
        """Generate error summary and next steps section of the report."""
        section = "\n## Error Summary\n"
        if self.errors:
            section += f"**{len(self.errors)} errors occurred during fixing**:\n"
            for error in self.errors:
                section += f"- {error['file']}: {error['error']}\n"
        else:
            section += "All fixes applied successfully with no errors.\n"
        section += """
## Next Steps
...
"""
        ...
        report += self._report_recommendations()
        report += self._report_error_summary()
...
def main():
    ...
    try:
        ...
        # Save fixes summary
        with open(results_dir / "vue_fixes_summary.json", "w", encoding="utf-8") as f:
        ...
        # Print summary
        print("\n" + "=" * 60)  # noqa: print
        print("VUE.JS SPECIFIC FIX AGENT - EXECUTION COMPLETE")  # noqa: print
        print("=" * 60)  # noqa: print
        ...
        print("- vue_fixes_summary.json")  # noqa: print
