...
# Author: mrveiss
"""
A2A Security Cards — agent identity verification.
...
_SECRET = os.environ.get("AUTOBOT_A2A_SECRET", "")  # ssot-config-exempt: A2A security module — reads live env, bypasses cache

# How long a signed card is considered fresh (seconds).
try:
    _CARD_TTL = int(os.environ.get("AUTOBOT_A2A_CARD_TTL", "3600"))  # ssot-config-exempt: int-wrapping type conversion per GH#7743
except ValueError:
