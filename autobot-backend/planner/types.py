...
class PlanStep:
    ...
    def from_dict(cls, data: dict) -> "PlanStep":
        return cls(
            ...
            started_at=(parse_utc_iso(data["started_at"]) if data.get("started_at") else None),
            completed_at=(parse_utc_iso(data["completed_at"]) if data.get("completed_at") else None),
...
class ExecutionPlan:
    ...
    def from_dict(cls, data: dict) -> "ExecutionPlan":
        plan = cls(
            ...
            created_at=(parse_utc_iso(data["created_at"]) if data.get("created_at") else now_utc()),
            started_at=(parse_utc_iso(data["started_at"]) if data.get("started_at") else None),
            completed_at=(parse_utc_iso(data["completed_at"]) if data.get("completed_at") else None),
