...
class BulkOperationsMixin:
    ...
    async def _get_import_content(
        ...
        return None, {
            "status": "error",
            "message": "Either source_file or data required",
        }

    def _parse_import_data(self, content: str, format: str) -> tuple:
    ...
    def _build_dry_run_response(self, backup_data: Dict[str, Any]) -> Dict[str, Any]:
        """
