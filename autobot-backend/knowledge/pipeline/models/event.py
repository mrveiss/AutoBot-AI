...
class TemporalEvent(BaseModel):
    ...
    timestamp: Optional[datetime] = Field(None, description="Absolute event timestamp (if known)")
    date_range_start: Optional[datetime] = Field(None, description="Range start (for duration events)")
    date_range_end: Optional[datetime] = Field(None, description="Range end (for duration events)")
