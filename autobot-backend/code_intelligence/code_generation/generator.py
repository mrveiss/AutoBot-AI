...
try:
    ...
    logger.warning("LLMService not available - code generation will fail without LLM client")
...
class LLMCodeGenerator:
    ...
    async def _call_llm(self, system_prompt: str, user_prompt: str) -> str:
        ...
        # Fallback for clients with generate method
            ...
            raise ValueError(
                "LLM client must have chat or generate method. " f"Client type: {type(self.llm_client).__name__}"
            )
