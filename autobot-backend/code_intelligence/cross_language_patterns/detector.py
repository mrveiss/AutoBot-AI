    ...
    async def _get_chromadb_collection(self):
        ...
        if self._chromadb_collection is None:
            try:
                ...
                self._chromadb_client = await get_async_chromadb_client(db_path=str(chromadb_path))
    ...
    async def _get_redis_client(self):
        ...
        if self._redis_client is None and self.use_cache:
            try:
                ...
                self._redis_client = get_redis_client(async_client=True, database="analytics")
