...
Issue #9856: Restored local definitions; ssot_constants only absorbed
PLACEHOLDER_PATTERNS, HTTP_METHODS, INSECURE_RANDOM_FUNCS — the remaining
security-specific constants (enums, frozensets, mappings) live here.
"""
