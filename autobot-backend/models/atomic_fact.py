...
class AtomicFact:
    ...
    def is_contradictory_to(self, other_fact: "AtomicFact") -> bool:
        ...
        if (
            self.subject == other_fact.subject
    ...
    def should_invalidate(self, new_fact: "AtomicFact") -> bool:
        ...
        if new_fact.is_contradictory_to(self):
            ...
            return new_fact.valid_from > self.valid_from and new_fact.confidence >= 0.6

        return False

    def invalidate(
        self,
        invalidating_fact: "AtomicFact",
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "AtomicFact":
        ...
        valid_until = parse_utc_iso(data["valid_until"]) if data.get("valid_until") else None
        last_verified = parse_utc_iso(data["last_verified"]) if data.get("last_verified") else None
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"AtomicFact(id={self.fact_id[:8]}..., "
