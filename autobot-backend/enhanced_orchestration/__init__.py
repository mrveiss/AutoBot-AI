...
(orchestrator.py deleted as part of 5→4 orchestrator file consolidation).
...
class EnhancedMultiAgentOrchestrator:
    ...
    Issue #4048: Inlined into __init__.py (orchestrator.py deleted).
...
__all__ = [
    ...
    # Issue #4048: inlined from orchestrator.py into __init__.py
