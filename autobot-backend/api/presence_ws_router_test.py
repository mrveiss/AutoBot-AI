...
class TestPresenceWSRouter:
    ...
    def test_router_has_websocket_endpoint(self):
        ...
        presence_routes = [
            r for r in router.routes if "presence" in str(r.path).lower()
        ]
    ...
    def test_router_tags(self):
        ...
        assert "collaboration" in tags or "websocket" in tags or "presence" in tags, (
...
class TestPresenceWSConfiguration:
    ...
    def test_router_registered_in_feature_routers_config(self):
        ...
        config_file = "/home/martins/AutoBot-Ai/AutoBot-AI/autobot-backend/initialization/router_registry/feature_routers.py"
