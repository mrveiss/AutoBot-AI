...
def _build_service_list(results: list) -> list:
    ...
    return [
        _to_service_entry("Backend API", ConfigRegistry.get("vm.main"), int(ConfigRegistry.get("port.backend")), "online", "Running"),
        _to_service_entry("Redis", ConfigRegistry.get("vm.redis"), int(ConfigRegistry.get("port.redis")), redis_s, redis_m),
        _to_service_entry("NPU Worker", ConfigRegistry.get("vm.npu"), int(ConfigRegistry.get("port.npu")), npu_s, npu_m),
        _to_service_entry("Ollama", ConfigRegistry.get("vm.llm"), int(ConfigRegistry.get("port.ollama")), ollama_s, ollama_m),
        _to_service_entry("Browser", ConfigRegistry.get("vm.browser"), int(ConfigRegistry.get("port.browser")), browser_s, browser_m),
    ]
