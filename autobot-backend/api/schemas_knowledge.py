...
class SearchRequest(BaseModel):
    ...
    # Advanced options (folded from former /enhanced_search_v2 — #10666)
    ...
    def to_advanced_params(self) -> dict:
        """Convert to full parameter dict for KB advanced search (expansion/clustering/filtering — #10666)."""
        return {
            "query": self.query,
            "limit": self.limit,
            "offset": self.offset,
    ...
    def uses_advanced_features(self) -> bool:
        """Return True when any advanced search field is set (expansion/clustering/filtering — #10666)."""
        return bool(
