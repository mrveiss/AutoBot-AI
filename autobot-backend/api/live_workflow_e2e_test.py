...
async def test_live_workflow_system():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        try:
            ...
            from agents.web_researcher import ResearchRequest, get_web_researcher

            research_agent = get_web_researcher()
...
async def main():
    ...
    if success:
        ...
        print("   1. Open frontend: http://localhost:5173")  # noqa: print  # canonical: ignore py-hardcoded-url — test fixture/mock URL, not an executable default
