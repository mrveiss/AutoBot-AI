...
class TestExtractPattern:
    ...
    def test_npm_subcommand_preserved(self, manager) -> None:
    ...
    def test_docker_subcommand_preserved(self, manager) -> None:
    ...
    def test_empty_command(self, manager) -> None:
...
class TestRedisKey:
    ...
    def test_key_format(self, manager) -> None:
...
class TestRememberApproval:
    ...
    @pytest.mark.asyncio
    async def test_stores_approval_in_redis(self, manager) -> None:
        """Approval is stored in Redis with TTL."""
        mock_redis = AsyncMock()
        mock_redis.get.return_value = None

        with patch("services.approval_memory.get_async_redis_client", return_value=mock_redis):
    ...
    @pytest.mark.asyncio
    async def test_updates_existing_record(self, manager) -> None:
    ...
    @pytest.mark.asyncio
    async def test_redis_unavailable_returns_false(self, manager) -> None:
...
class TestCheckRemembered:
    ...
    @pytest.mark.asyncio
    async def test_matching_pattern_auto_approves(self, manager) -> None:
    ...
    @pytest.mark.asyncio
    async def test_lower_risk_auto_approves(self, manager) -> None:
    ...
    @pytest.mark.asyncio
    async def test_higher_risk_denies_auto_approve(self, manager) -> None:
    ...
    @pytest.mark.asyncio
    async def test_no_stored_records(self, manager) -> None:
    ...
    @pytest.mark.asyncio
    async def test_pattern_mismatch(self, manager) -> None:
    ...
    @pytest.mark.asyncio
    async def test_tool_mismatch(self, manager) -> None:
    ...
    @pytest.mark.asyncio
    async def test_corrupt_json_returns_false(self, manager) -> None:
...
class TestHelperMethods:
    ...
    @pytest.mark.asyncio
    async def test_load_existing_records_empty(self, manager) -> None:
    ...
    @pytest.mark.asyncio
    async def test_load_existing_records_valid_json(self, manager) -> None:
    ...
    @pytest.mark.asyncio
    async def test_load_existing_records_invalid_json(self, manager) -> None:
    ...
    def test_update_or_add_new_record(self, manager) -> None:
    ...
    def test_update_or_add_existing_record(self, manager) -> None:
