...
class TestTerminalCompletionService:
    ...
    def test_extract_current_word_simple(self, service) -> None:
        """Extract word at cursor position."""
        result = service._extract_current_word("cd /home/user/Doc", 17)
        assert result == "Doc"

    def test_extract_current_word_empty(self, service) -> None:
        """Empty word at start."""
        result = service._extract_current_word("", 0)
        assert result == ""

    def test_is_first_word_true(self, service) -> None:
    ...
    def test_is_first_word_false(self, service) -> None:
