...
class TestAbbreviationAwareSplitting:
    ...
    def test_dr_with_real_sentence_break(self):
    ...
    def test_eg_with_following_sentence(self):
    ...
    def test_mixed_abbreviations_and_real_breaks(self):
    ...
    def test_question_mark_still_splits(self):
    ...
    def test_exclamation_mark_still_splits(self):
