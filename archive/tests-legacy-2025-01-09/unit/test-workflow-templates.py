...
# Add project root to path dynamically - this file is in tests/unit/
...
async def test_template_api_integration():
    ...
    try:
        ...
        # Use environment-configured backend URL
        backend_host = os.getenv("AUTOBOT_BACKEND_HOST", "localhost")
