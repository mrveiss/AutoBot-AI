...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_audit_org_created", "audit_logs", ["org_id", "created_at"]
    )
    op.create_index(
        "idx_audit_user_created", "audit_logs", ["user_id", "created_at"]
    )
    op.create_index(
        "idx_audit_action_created", "audit_logs", ["action", "created_at"]
    )
