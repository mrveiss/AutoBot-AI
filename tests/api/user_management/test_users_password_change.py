...
from src.user_management.middleware.rate_limit import RateLimitExceeded
    ...
    async def test_rate_limit_check_called_before_change(
        ...
        with patch(
            ...
            with patch(
                ...
                from src.user_management.schemas import PasswordChange

                pwd_change = PasswordChange(**password_data)
                await change_password(user_id, pwd_change, mock_user_service)
...
class TestPasswordChangeResponses:
    ...
    async def test_successful_change_returns_success_message(
        ...
        with patch(
            ...
            pwd_change = PasswordChange(**password_data)
            response = await change_password(user_id, pwd_change, mock_user_service)
