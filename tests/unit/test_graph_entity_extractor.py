...
def test_infer_relationships(entity_extractor):
    ...
    for relation in relations:
        ...
        assert relation.relation_type in entity_extractor.relationship_keywords.keys() or relation.relation_type == "relates_to"
...
@pytest.mark.asyncio
async def test_create_entities_handles_graph_error(
    entity_extractor, mock_memory_graph
):
