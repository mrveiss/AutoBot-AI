...
def test_ansi_escape_sequences():
    ...
    test_cases = [
        ...
        },
        {
            ...
            "input": "\x1b[1meth0\x1b[0m: flags=4163<UP,BROADCAST,RUNNING,MULTICAST>  mtu 1500\n        inet \x1b[32m192.168.1.100\x1b[0m  netmask 255.255.255.0",
            "expected": "eth0: flags=4163<UP,BROADCAST,RUNNING,MULTICAST>  mtu 1500\n        inet 192.168.1.100  netmask 255.255.255.0"
        },
        {
