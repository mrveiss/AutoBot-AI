...
class TestUnifiedConfigTimeouts:
    """Test UnifiedConfig timeout methods"""
    ...
    def test_get_timeout_for_env_production(self):
        ...
        expected = self.config.get('environments.production.timeouts.redis.operations.get')
    ...
    def test_get_timeout_for_env_development(self):
        ...
        expected = self.config.get('environments.development.timeouts.redis.operations.scan_iter')
        timeout = self.config.get_timeout_for_env(
            'redis.operations', 'scan_iter',
            environment='development'
        )
        assert timeout == expected
    ...
    def test_get_timeout_for_env_base_values(self):
        ...
        timeout = self.config.get_timeout_for_env(
            'redis.connection', 'socket_connect',
            environment='production'
        )
        assert timeout == expected
        ...
        timeout = self.config.get_timeout_for_env(
            'llamaindex.indexing', 'single_document',
            environment='production'
        )
        assert timeout == expected
...
class TestKnowledgeBaseTimeouts:
    ...
    def test_redis_operation_timeouts(self):
        ...
        expected_get = config.get_timeout_for_env('redis.operations', 'get', 'production')
        expected_set = config.get_timeout_for_env('redis.operations', 'set', 'production')
    ...
    def test_llamaindex_timeouts(self):
        ...
        expected_indexing_single = config.get('timeouts.llamaindex.indexing.single_document')
        expected_indexing_batch = config.get('timeouts.llamaindex.indexing.batch_documents')
        expected_search = config.get_timeout_for_env('llamaindex.search', 'query', 'production')
    ...
    def test_environment_awareness_production(self):
        ...
        expected_redis_get = config.get_timeout_for_env('redis.operations', 'get', 'production')
        expected_search = config.get_timeout_for_env('llamaindex.search', 'query', 'production')
    ...
    def test_environment_awareness_development(self):
        ...
        expected_scan_iter = config.get_timeout_for_env('redis.operations', 'scan_iter', 'development')
        expected_search = config.get_timeout_for_env('llamaindex.search', 'query', 'development')
