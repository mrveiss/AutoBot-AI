...
from src.code_intelligence.code_review_engine import (
    BUILTIN_PATTERNS,
    CodeReviewEngine,
    DiffFile,
    DiffHunk,
...
class TestBuiltinPatterns:
    ...
    def test_security_patterns(self):
        ...
        security_patterns = [
            p for p in BUILTIN_PATTERNS.values()
    ...
    def test_all_categories_covered(self):
        ...
        categories_with_patterns = set(
            p.category for p in BUILTIN_PATTERNS.values()
        )
...
class TestIntegration:
    ...
    def test_full_file_review(self, tmp_path, sample_python_code):
        ...
        assert ReviewCategory.SECURITY in categories or \
            ReviewCategory.BEST_PRACTICE in categories
