...
from agents.base_agent import (
    create_agent_request, AgentRequest, AgentResponse,
    DeploymentMode, AgentStatus, AgentHealth, LocalAgent
)
...
async def test_base_agent_interface():
    ...
    # Test ping
    ping_request = create_agent_request(
        agent_type="test",
        action="ping",
        payload={}
    )
    ...
    logger.info(f"Final stats - Total: {final_stats['total_requests']}, "
...
async def test_serialization():
    ...
    from agents.base_agent import serialize_agent_request, deserialize_agent_request
