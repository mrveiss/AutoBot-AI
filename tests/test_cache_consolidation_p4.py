...
def test_simple_cache_basic_operations():
    ...
    try:
        from src.utils.advanced_cache_manager import SimpleCacheManager
...
def test_advanced_cache_manager_features():
    ...
    try:
        from src.utils.advanced_cache_manager import AdvancedCacheManager, CacheStrategy

        # Test KNOWLEDGE strategy exists
        assert hasattr(
            CacheStrategy, "KNOWLEDGE"
        ), "Missing KNOWLEDGE cache strategy"
...
def test_cache_function_decorator():
    ...
    try:
        from src.utils.advanced_cache_manager import cache_function
        ...
        assert callable(
            decorator
        ), "cache_function decorator should return callable"
...
def test_feature_completeness():
    ...
    try:
        ...
        print(f"✓ All {len(adv_features)} AdvancedCacheManager original features present")
        ...
        strategies = ["STATIC", "DYNAMIC", "USER_SCOPED", "COMPUTED", "TEMPORARY", "KNOWLEDGE"]
...
def run_all_tests():
    ...
    tests = [
        ...
        ("AdvancedCacheManager Knowledge Features", test_advanced_cache_manager_features),
        ("SimpleCacheManager Backward Compatibility", test_backward_compatibility_simple),
