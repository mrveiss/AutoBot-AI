...
class FileUploadAPITests(unittest.TestCase):
    ...
    def test_file_listing(self):
        ...
        try:
            ...
            for file_info in files:
                required_fields = ['name', 'path', 'is_directory', 'last_modified', 'permissions']
    ...
    def test_file_statistics(self):
        ...
        try:
            ...
            result = response.json()
            required_fields = [
                'sandbox_root', 'total_files', 'total_directories', 
                'total_size', 'max_file_size_mb', 'allowed_extensions'
            ]
