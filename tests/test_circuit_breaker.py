...
from src.circuit_breaker import (
    ...
    CircuitBreakerManager, circuit_breaker_async, circuit_breaker_sync,
...
class TestCircuitBreakerDecorators:
    ...
    async def test_async_decorator_failure_and_opening(self):
        ...
        @circuit_breaker_async("failing_service", failure_threshold=2, recovery_timeout=0.1)
...
class TestCircuitBreakerIntegration:
    ...
    async def test_circuit_breaker_with_retry_mechanism(self):
        ...
        @circuit_breaker_async("retry_service", failure_threshold=3, recovery_timeout=0.1)
