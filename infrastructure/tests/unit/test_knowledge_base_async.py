...
async def knowledge_base_with_mock_redis(mock_redis_manager):
    ...
    with patch(
        "backend.utils.async_redis_manager.get_redis_manager",
...
class TestAsyncRedisInitialization:
    ...
    @pytest.mark.asyncio
    async def test_redis_initialization_success(
        self, mock_redis_manager, mock_redis_client
    ):
        """
    ...
    async def test_redis_initialization_connection_failure(self, mock_redis_manager):
        ...
        mock_redis_manager.main = AsyncMock(
...
class TestStoreFact:
    ...
    async def test_store_fact_success(
        self, knowledge_base_with_mock_redis, mock_redis_client
    ):
        """
...
class TestGetFactById:
    ...
    @pytest.mark.asyncio
    async def test_get_fact_by_id_success(
        self, knowledge_base_with_mock_redis, mock_redis_client
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_get_fact_by_id_timeout(
        self, knowledge_base_with_mock_redis, mock_redis_client
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_get_fact_by_id_not_found(
        self, knowledge_base_with_mock_redis, mock_redis_client
    ):
        """
...
class TestGetFactByQuery:
    ...
    @pytest.mark.asyncio
    async def test_get_fact_by_query_success(
        self, knowledge_base_with_mock_redis, mock_redis_client
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_get_fact_by_query_no_matches(
        self, knowledge_base_with_mock_redis, mock_redis_client
    ):
        """
...
class TestGetAllFacts:
    ...
    @pytest.mark.asyncio
    async def test_get_all_facts_with_pipeline(
        self, knowledge_base_with_mock_redis, mock_redis_client
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_get_all_facts_timeout(
        self, knowledge_base_with_mock_redis, mock_redis_client
    ):
        """
    ...
    @pytest.mark.asyncio
    async def test_get_all_facts_empty(
        self, knowledge_base_with_mock_redis, mock_redis_client
    ):
        """
...
class TestTimeoutHandling:
    ...
    @pytest.mark.asyncio
    async def test_asyncio_wait_for_timeout_protection(
        self, knowledge_base_with_mock_redis, mock_redis_client
    ):
        """
