...
class AutoBotMonitor:
        ...
        if analysis_files:
            ...
            try:
                ...
                logger.info(
                    ...
                    len(static.get("function_definitions", {})),
                )
                logger.info(
                    "High Complexity: %d",
                    len(hotspots.get("high_complexity_functions", [])),
                )
    ...
    def check_security_status(self):
        ...
        try:
            ...
            if (
                safe_test
                and safe_test.get("type") == "system_info"
                and danger_test
                and danger_test.get("type") == "blocked"
            ):
