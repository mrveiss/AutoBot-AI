...
class TestAutoRecovery:
    ...
    async def test_auto_recovery_disabled_by_config(self, test_config):
        ...
        if not auto_recovery_enabled:
            recovery = RecoveryResult(success=False, reason="Auto-recovery disabled")
...
class TestAuditLogging:
    ...
    async def test_audit_log_service_operation(self):
        ...
        audit_entry = {
            ...
            "service": "redis",
            "operation": "restart",
            "user": {"id": "user-123", "email": "admin@autobot.local", "role": "admin"},
            "result": {"success": True, "duration_seconds": 15.7, "exit_code": 0},
        }
