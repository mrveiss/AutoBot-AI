    ...
    def get_provider_endpoint_template(provider_type: str, domain: str = "") -> dict[str, str]:
        ...
        templates = {
            ...
            SSOProviderType.GOOGLE_WORKSPACE.value: {
                ...
                "token_url": "https://oauth2.googleapis.com/token",  # nosec B105 - OAuth2 public token endpoint URL, not a credential
                "userinfo_url": "https://openidconnect.googleapis.com/v1/userinfo",
                "scope": "openid email profile",
            },
            SSOProviderType.GITHUB.value: {
                "authorize_url": "https://github.com/login/oauth/authorize",
                "token_url": "https://github.com/login/oauth/access_token",  # nosec B105 - OAuth2 public token endpoint URL, not a credential
