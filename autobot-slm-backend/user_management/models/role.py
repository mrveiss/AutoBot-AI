...
This file's only diff from the backend's copy was cosmetic (an unused
``Optional`` import and ``Mapped[Optional[...]]`` vs ``Mapped["... | None"]``
style) — see ``autobot_shared/user_management/models/role.py`` for the
